...
#
# Script generated by Vivado on Fri Mar 07 18:12:59 CST 2025
...
#
# Usage        : ram_ila.sh
#                ram_ila.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ram_ila.sh [-reset_run]
#                ram_ila.sh [-reset_log]
#                ram_ila.sh [-help]
#
...
#                script (type 'ram_ila.sh -help' for more information).
#
...
# script info
echo -e "ram_ila.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ram_ila.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../RISC_2.gen/sources_1/ip/ram_ila/hdl/verilog" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../RISC_2.gen/sources_1/ip/ram_ila/hdl/verilog" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.ram_ila xil_defaultlib.glbl -o ram_ila_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./ram_ila_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/moonknight/Documents/spring25/risc/RISC_2/RISC_2.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key ram_ila_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc ram_ila_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ram_ila.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ram_ila.sh [-help]\n\
Usage: ram_ila.sh [-step]\n\
Usage: ram_ila.sh [-lib_map_path]\n\
Usage: ram_ila.sh [-reset_run]\n\
Usage: ram_ila.sh [-reset_log]\n\
Usage: ram_ila.sh [-keep_index]\n\
Usage: ram_ila.sh [-noclean_files]\n\n\
