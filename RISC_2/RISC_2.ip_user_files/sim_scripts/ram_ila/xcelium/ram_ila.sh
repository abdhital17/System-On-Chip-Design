...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../RISC_2.gen/sources_1/ip/ram_ila/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../RISC_2.gen/sources_1/ip/ram_ila/hdl/verilog" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.ram_ila xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.ram_ila -input simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/moonknight/Documents/spring25/risc/RISC_2/RISC_2.cache/compile_simlib/xcelium"
  fi
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log ram_ila_sc.so .tmp_log xcelium_lib waves.shm c.obj)
