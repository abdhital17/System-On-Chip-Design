...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../RISC_2.gen/sources_1/ip/ila_0/hdl/verilog" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../RISC_2.gen/sources_1/ip/ila_0/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/moonknight/Documents/risc/RISC_2/RISC_2.cache/compile_simlib/xcelium"
  fi
