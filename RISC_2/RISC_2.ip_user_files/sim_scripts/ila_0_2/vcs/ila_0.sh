...
#
# Script generated by Vivado on Wed Feb 19 22:25:58 CST 2025
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../../RISC_2.gen/sources_1/ip/ila_0/hdl/verilog" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../../RISC_2.gen/sources_1/ip/ila_0/hdl/verilog" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/moonknight/Documents/risc/RISC_2/RISC_2.cache/compile_simlib/vcs"
  fi
