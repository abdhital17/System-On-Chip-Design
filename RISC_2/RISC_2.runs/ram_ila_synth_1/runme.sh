...
HD_PWD='/home/moonknight/Documents/risc/RISC_2/RISC_2.runs/ram_ila_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ram_ila.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ram_ila.tcl
