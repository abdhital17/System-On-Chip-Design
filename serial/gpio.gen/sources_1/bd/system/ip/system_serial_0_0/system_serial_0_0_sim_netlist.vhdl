...
architecture STRUCTURE of system_serial_0_0_edge_detector_0 is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of overflow_i_2 : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \rd_index[4]_i_3\ : label is "soft_lutpair9";
begin
...
read_request_detector: entity work.system_serial_0_0_edge_detector
     port map (
      E(0) => rd,
      axi_aclk => axi_aclk,
...
write_request_detector: entity work.system_serial_0_0_edge_detector_0
     port map (
      axi_aclk => axi_aclk,
      ...
      status(0) => status(0),
      \status_reg[0]\ => write_request_detector_n_1,
      \wr_request0__0\ => \wr_request0__0\,
      write_en => write_en
    );
end STRUCTURE;
