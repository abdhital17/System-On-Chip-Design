...
architecture STRUCTURE of system_serial_0_2_receiver is
  ...
  signal frame_error_i_4_n_0 : STD_LOGIC;
  signal in_prev15_out : STD_LOGIC;
  ...
  signal \latched_data[7]_i_4_n_0\ : STD_LOGIC;
  ...
  signal parity_error3_out : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_state[3]_i_3__0\ : label is "soft_lutpair19";
  ...
  attribute SOFT_HLUTNM of frame_error_i_3 : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of frame_error_i_4 : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of in_prev_i_1 : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \latched_data[1]_i_2\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \latched_data[4]_i_2\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \latched_data[5]_i_3\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \latched_data[6]_i_2\ : label is "soft_lutpair20";
  ...
  attribute SOFT_HLUTNM of \latched_data[7]_i_4\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \latched_data[8]_i_2\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \latched_data[8]_i_3\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \latched_data[8]_i_5\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \latched_data[8]_i_6\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of parity_error_i_2 : label is "soft_lutpair21";
...
frame_error_i_2: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => bit_in,
      I4 => latched_data0_in(7),
      I5 => in_prev15_out,
      O => frame_error5_out
    );
frame_error_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4000"
    )
        port map (
...
frame_error_i_4: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
in_prev_i_2: unisim.vcomponents.LUT6
    generic map(
...
\latched_data[5]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"40"
    )
        port map (
...
\latched_data[7]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\latched_data[7]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"02"
    )
        port map (
...
\latched_data[8]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\latched_data[8]_i_5\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"02"
    )
        port map (
...
\latched_data[8]_i_6\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0800"
    )
        port map (
...
architecture STRUCTURE of system_serial_0_2_transmitter is
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_state[0]_i_12\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \FSM_sequential_state[0]_i_13\ : label is "soft_lutpair28";
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_state[0]_i_8\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of \FSM_sequential_state[0]_i_9\ : label is "soft_lutpair25";
  attribute FSM_ENCODED_STATES : string;
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[0]\ : label is "D2:0100,D1:0011,D0:0010,STOP2:1100,STOP1:1011,P:1010,START:0001,IDLE:0000,D5:0111,D7:1001,D4:0110,D6:1000,D3:0101";
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[1]\ : label is "D2:0100,D1:0011,D0:0010,STOP2:1100,STOP1:1011,P:1010,START:0001,IDLE:0000,D5:0111,D7:1001,D4:0110,D6:1000,D3:0101";
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[2]\ : label is "D2:0100,D1:0011,D0:0010,STOP2:1100,STOP1:1011,P:1010,START:0001,IDLE:0000,D5:0111,D7:1001,D4:0110,D6:1000,D3:0101";
  ...
  attribute SOFT_HLUTNM of \ones[0]_i_2__0\ : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of out_data_i_3 : label is "soft_lutpair25";
...
\ones[0]_i_2__0\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
architecture STRUCTURE of system_serial_0_2_serial_v1_0_AXI is
  ...
  attribute SOFT_HLUTNM of \control[31]_i_2\ : label is "soft_lutpair35";
  attribute SOFT_HLUTNM of \raddr[3]_i_1\ : label is "soft_lutpair36";
  attribute SOFT_HLUTNM of \status[7]_i_2\ : label is "soft_lutpair35";
begin
