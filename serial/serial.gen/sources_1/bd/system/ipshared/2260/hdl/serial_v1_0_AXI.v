    ...
    begin
        ...
        begin    
            ...
            begin
		        ...
		        STATUS_REG:
		            axi_rdata <= {11'b0, watermark_tx[4:0], 3'b0, watermark_rx[4:0], parity_error, frame_error, overflow_tx, tx_empty, tx_full, overflow_rx, rx_empty, rx_full};
		        CONTROL_REG:
