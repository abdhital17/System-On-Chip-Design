module receiver(
    ...
    begin
        ...
        begin
            ...
            if (brgen_counter == 8)         // sample bit 7 from the 7/16th iteration of baudrate
            begin
                bit_a <= in;
            end
            else if (brgen_counter == 9)   // sample bit 8 from the 8/16th iteration of the baudrate
            begin
                bit_b <= in;
            end
            else if (brgen_counter == 10)    // sample bit 9 from the 9/16th iteration of the baudrate
            begin
                bit_c <= in;
            end
