...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9 is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_state[0]_i_7\ : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of \wr_index[4]_i_2\ : label is "soft_lutpair2";
begin
  SR(0) <= \^sr\(0);
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter is
  ...
  attribute SOFT_HLUTNM of baud_en : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \brgen_counter[0]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \brgen_counter[1]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \brgen_counter[2]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \brgen_counter[3]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \brgen_counter[4]_i_2\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of out_data_i_3 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of out_data_i_4 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of parity_bit_i_2 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \pulse_i_1__0\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of rd_request_i_1 : label is "soft_lutpair10";
begin
...
out_data_i_6: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AAAA8AA2AAAA0820"
    )
        port map (
      I0 => state(1),
      I1 => Q(2),
      I2 => Q(3),
      I3 => parity_bit_reg_n_0,
      I4 => state(0),
...
fifo_tx: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9
     port map (
      ...
      \brd_reg[20]\(7) => fifo_tx_n_11,
      \brd_reg[20]\(6) => fifo_tx_n_12,
      \brd_reg[20]\(5) => fifo_tx_n_13,
      \brd_reg[20]\(4) => fifo_tx_n_14,
      \brd_reg[20]\(3) => fifo_tx_n_15,
      \brd_reg[20]\(2) => fifo_tx_n_16,
      \brd_reg[20]\(1) => fifo_tx_n_17,
      \brd_reg[20]\(0) => fifo_tx_n_18,
      ok_to_read_tx_edge => ok_to_read_tx_edge,
      ok_to_write_tx => ok_to_write_tx,
      raddr(1 downto 0) => raddr(3 downto 2),
      \rd_index_reg[1]_0\ => fifo_tx_n_10,
      \rd_index_reg[1]_1\ => fifo_tx_n_21,
...
read_request_detector_tx: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detector
     port map (
      axi_aclk => axi_aclk,
      ok_to_read_tx => ok_to_read_tx,
      ok_to_read_tx_edge => ok_to_read_tx_edge,
...
transmitter_1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter
     port map (
      D(8 downto 0) => rd_data(8 downto 0),
      E(0) => brgen_counter0,
      \FSM_sequential_state_reg[0]_0\ => fifo_tx_n_10,
...
write_request_detector_tx: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detector_0
     port map (
      axi_aclk => axi_aclk,
