...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detector_2 is
  ...
  signal \^wr\ : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of previous_state_i_1 : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of pulse_i_1 : label is "soft_lutpair19";
begin
  wr <= \^wr\;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9 is
  signal \p_0_in__2\ : STD_LOGIC_VECTOR ( 4 downto 2 );
  ...
  attribute SOFT_HLUTNM of \rd_index[2]_i_1__0\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \rd_index[4]_i_4\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \watermark[2]_i_1__0\ : label is "soft_lutpair4";
...
\axi_rdata[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \rd_index[4]_i_4_n_0\,
      I3 => p_0_in_0(0),
      I4 => p_0_in_0(1),
      I5 => \axi_rdata_reg[12]\(0),
      O => D(0)
    );
...
\rd_index[4]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9_0 is
  ...
  signal fifo_reg_0_15_0_5_i_3_n_0 : STD_LOGIC;
  signal fifo_reg_0_15_0_5_i_4_n_0 : STD_LOGIC;
  ...
  signal \watermark[3]_i_2_n_0\ : STD_LOGIC;
  signal \watermark[3]_i_3_n_0\ : STD_LOGIC;
  signal \watermark[4]_i_2_n_0\ : STD_LOGIC;
  signal \watermark[4]_i_3_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \axi_rdata[4]_i_3\ : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of overflow_i_3 : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \rd_index[3]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \rd_index[4]_i_2__0\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \watermark[3]_i_3\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \wr_index[2]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \wr_index[3]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \wr_index[4]_i_2\ : label is "soft_lutpair6";
begin
  SR(0) <= \^sr\(0);
...
fifo_reg_0_15_0_5_i_3: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => \watermark[3]_i_2_n_0\,
      I5 => fifo_reg_0_15_0_5_i_4_n_0,
      O => fifo_reg_0_15_0_5_i_3_n_0
    );
fifo_reg_0_15_0_5_i_4: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
...
overflow_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9009"
    )
        port map (
...
\watermark[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"6A56AAAA55556A56"
    )
        port map (
      I0 => \watermark[3]_i_2_n_0\,
      I1 => \watermark[3]_i_3_n_0\,
...
\watermark[3]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"9"
    )
        port map (
      ...
      O => \watermark[3]_i_2_n_0\
    );
\watermark[3]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
      ...
      I1 => \rd_index_reg_n_0_[0]\,
      O => \watermark[3]_i_3_n_0\
    );
\watermark[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"A0FACF0CCF0CA0FA"
    )
        port map (
      I0 => \watermark[4]_i_2_n_0\,
      I1 => \watermark[4]_i_3_n_0\,
...
\watermark[4]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter is
  ...
  attribute SOFT_HLUTNM of \ones[0]_i_3\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of out_data_i_7 : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \pulse_i_1__1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of rd_request_i_1 : label is "soft_lutpair17";
begin
...
\ones[0]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"9669"
    )
        port map (
...
out_data_i_4: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => state(3),
      I4 => state(1),
      I5 => \latched_data_reg_n_0_[8]\,
      O => out_data_i_4_n_0
    );
out_data_i_5: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AA000000AA0000CF"
    )
        port map (
      I0 => in20,
...
out_data_i_7: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  ...
  attribute SOFT_HLUTNM of \raddr[3]_i_1\ : label is "soft_lutpair20";
begin
