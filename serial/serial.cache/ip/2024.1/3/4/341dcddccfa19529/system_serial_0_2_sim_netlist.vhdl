...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_brd is
  ...
  attribute SOFT_HLUTNM of \ones[0]_i_3__0\ : label is "soft_lutpair0";
begin
  brd_out <= \^brd_out\;
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9 is
  port (
    ...
    \axi_rdata_reg[6]\ : in STD_LOGIC_VECTOR ( 1 downto 0 );
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  port (
    test_reg_reg_0 : out STD_LOGIC_VECTOR ( 0 to 0 );
    ...
    brgen_prev : in STD_LOGIC;
    axi_aresetn : in STD_LOGIC;
    \brgen_counter_reg[3]_0\ : in STD_LOGIC;
    Q : in STD_LOGIC_VECTOR ( 4 downto 0 );
    \ones_reg[0]_0\ : in STD_LOGIC;
    \FSM_sequential_state_reg[0]_0\ : in STD_LOGIC;
    \FSM_sequential_state_reg[2]_0\ : in STD_LOGIC;
    fe_out_reg : in STD_LOGIC;
    fe_out_reg_0 : in STD_LOGIC_VECTOR ( 1 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  ...
  signal frame_error9_out : STD_LOGIC;
  ...
  signal latched_data : STD_LOGIC_VECTOR ( 8 to 8 );
  ...
  signal \latched_data[2]_i_4_n_0\ : STD_LOGIC;
  ...
  signal parity_bit5_out : STD_LOGIC;
  ...
  signal test_reg1_out : STD_LOGIC;
  signal test_reg_i_1_n_0 : STD_LOGIC;
  signal test_reg_i_3_n_0 : STD_LOGIC;
  signal \^test_reg_reg_0\ : STD_LOGIC_VECTOR ( 0 to 0 );
  signal wr_request_i_1_n_0 : STD_LOGIC;
  signal wr_request_i_2_n_0 : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_state[0]_i_2__0\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \FSM_sequential_state[0]_i_4__0\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \FSM_sequential_state[0]_i_6__0\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \FSM_sequential_state[1]_i_3\ : label is "soft_lutpair24";
  ...
  attribute SOFT_HLUTNM of \brgen_counter[1]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \brgen_counter[2]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \brgen_counter[3]_i_3\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \latched_data[1]_i_2\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \latched_data[2]_i_2\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \latched_data[2]_i_3\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \latched_data[5]_i_2\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \latched_data[6]_i_2\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \latched_data[8]_i_2\ : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of test_reg_i_1 : label is "soft_lutpair22";
...
begin
  ...
  test_reg_reg_0(0) <= \^test_reg_reg_0\(0);
\FSM_sequential_state[0]_i_1__0\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFF00005DFD"
    )
        port map (
...
\latched_data[6]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\latched_data[8]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => state(3),
      I3 => test_reg1_out,
      I4 => \latched_data[8]_i_2_n_0\,
      I5 => \^data\(8),
      O => \latched_data[8]_i_1_n_0\
    );
\latched_data[8]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
test_reg_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
test_reg_i_2: unisim.vcomponents.LUT6
    generic map(
...
test_reg_i_3: unisim.vcomponents.LUT6
    generic map(
...
test_reg_reg: unisim.vcomponents.FDRE
     port map (
      C => axi_aclk,
      CE => '1',
      D => test_reg_i_1_n_0,
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter is
  port (
    ...
    parity_bit_reg_0 : out STD_LOGIC_VECTOR ( 0 to 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter is
  ...
  signal \^parity_bit_reg_0\ : STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_state[0]_i_3__0\ : label is "soft_lutpair25";
  ...
  attribute SOFT_HLUTNM of \brgen_counter[0]_i_1__0\ : label is "soft_lutpair30";
...
begin
  ...
  parity_bit_reg_0(0) <= \^parity_bit_reg_0\(0);
  tx_out <= \^tx_out\;
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  port (
    ...
    fe_out_reg_0 : out STD_LOGIC_VECTOR ( 3 downto 0 );
    rd_index : out STD_LOGIC_VECTOR ( 0 to 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  ...
  signal data : STD_LOGIC_VECTOR ( 8 downto 0 );
  signal \^empty\ : STD_LOGIC;
  signal \^fe_out_reg_0\ : STD_LOGIC_VECTOR ( 3 downto 0 );
...
begin
  ...
  empty <= \^empty\;
  fe_out_reg_0(3 downto 0) <= \^fe_out_reg_0\(3 downto 0);
...
baudRateDivider: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_brd
     port map (
      ...
      axi_aresetn_0 => baudRateDivider_n_1,
      brd_out => brd_out,
      brgen_prev => brgen_prev,
      clk_out => clk_out,
...
fifo_rx: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9
     port map (
      ...
      \axi_rdata_reg[6]\(1 downto 0) => \^fe_out_reg_0\(3 downto 2),
      data(8 downto 0) => data(8 downto 0),
      empty => \^empty\,
      ok_to_write_rx_edge => ok_to_write_rx_edge,
...
fifo_tx: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9_0
     port map (
      ...
      \axi_rdata_reg[20]_0\(2) => p_0_in7_in,
...
receiver_1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver
     port map (
      ...
      axi_aresetn => axi_aresetn,
      brd_out => brd_out,
      \brgen_counter_reg[3]_0\ => transmitter_1_n_6,
      brgen_prev => brgen_prev,
      data(8 downto 0) => data(8 downto 0),
      fe_out_reg => \status_reg_n_0_[6]\,
      fe_out_reg_0(1 downto 0) => \^fe_out_reg_0\(3 downto 2),
      frame_error => frame_error,
      frame_error_prev => frame_error_prev,
      ok_to_write_rx => ok_to_write_rx,
      \ones_reg[0]_0\ => baudRateDivider_n_1,
      parity_error => parity_error,
      ...
      test_reg_reg_0(0) => \^fe_out_reg_0\(1),
...
transmitter_1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter
     port map (
      ...
      \control_reg[2]\ => transmitter_1_n_5,
      ok_to_read_tx => ok_to_read_tx,
      parity_bit_reg_0(0) => \^fe_out_reg_0\(0),
      previous_state => previous_state,
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial is
  port (
    ...
    empty : out STD_LOGIC;
    overflow_reg : out STD_LOGIC;
    fe_out_reg : out STD_LOGIC_VECTOR ( 3 downto 0 );
    rd_index : out STD_LOGIC_VECTOR ( 0 to 0 );
...
serial_v1_0_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI
     port map (
      ...
      clk_out => clk_out,
      empty => empty,
      fe_out_reg_0(3 downto 0) => fe_out_reg(3 downto 0),
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial
     port map (
      ...
      clk_out => clk_out,
      empty => empty,
      fe_out_reg(3) => \^rd_data\(8),
      fe_out_reg(2) => \^rd_data\(3),
      fe_out_reg(1 downto 0) => \^rd_data\(1 downto 0),
