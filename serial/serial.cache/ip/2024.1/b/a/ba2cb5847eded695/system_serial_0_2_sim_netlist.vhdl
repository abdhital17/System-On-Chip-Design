...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detector_3 is
  ...
  signal \^wr\ : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of previous_state_i_1 : label is "soft_lutpair34";
  attribute SOFT_HLUTNM of pulse_i_1 : label is "soft_lutpair34";
begin
  wr <= \^wr\;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  ...
  signal \^baud_pulse_reg\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_state[3]_i_3__0\ : label is "soft_lutpair22";
  ...
  attribute SOFT_HLUTNM of \brgen_counter[0]_i_1\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \brgen_counter[1]_i_1\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \brgen_counter[2]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \brgen_counter[3]_i_2\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \latched_data[0]_i_2\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \latched_data[1]_i_2\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \latched_data[2]_i_2\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \latched_data[2]_i_3\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \latched_data[3]_i_2\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \latched_data[5]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \latched_data[5]_i_2\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \latched_data[7]_i_2\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \latched_data[7]_i_3\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \ones[0]_i_2__0\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of parity_error_i_4 : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \test_reg[0]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \test_reg[2]_i_2\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \test_reg[5]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \test_reg[6]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \test_reg[7]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \test_reg[8]_i_2\ : label is "soft_lutpair18";
...
\brgen_counter[3]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6AAA"
    )
        port map (
...
frame_error_i_2: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000000018001901"
    )
        port map (
      I0 => \state__0\(1),
      I1 => \state__0\(0),
      I2 => \state__0\(2),
      I3 => frame_error_i_3_n_0,
      I4 => \state__0\(3),
      I5 => \test_reg_reg[2]_1\,
      O => frame_error7_out
    );
...
\latched_data[2]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\latched_data[4]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => \latched_data[7]_i_3_n_0\,
      I3 => \state__0\(0),
      I4 => \^data\(4),
      O => \latched_data[4]_i_1_n_0\
    );
\latched_data[5]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"EFFF2000"
    )
        port map (
...
\ones[0]_i_2__0\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000001"
    )
        port map (
...
\test_reg[2]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter is
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_state[0]_i_7\ : label is "soft_lutpair28";
  attribute FSM_ENCODED_STATES : string;
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[0]\ : label is "D2:0100,D1:0011,D0:0010,STOP2:1100,STOP1:1011,P:1010,START:0001,IDLE:0000,D5:0111,D7:1001,D4:0110,D6:1000,D3:0101";
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[1]\ : label is "D2:0100,D1:0011,D0:0010,STOP2:1100,STOP1:1011,P:1010,START:0001,IDLE:0000,D5:0111,D7:1001,D4:0110,D6:1000,D3:0101";
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[2]\ : label is "D2:0100,D1:0011,D0:0010,STOP2:1100,STOP1:1011,P:1010,START:0001,IDLE:0000,D5:0111,D7:1001,D4:0110,D6:1000,D3:0101";
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[3]\ : label is "D2:0100,D1:0011,D0:0010,STOP2:1100,STOP1:1011,P:1010,START:0001,IDLE:0000,D5:0111,D7:1001,D4:0110,D6:1000,D3:0101";
  attribute SOFT_HLUTNM of baud_en : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \brgen_counter[0]_i_1__0\ : label is "soft_lutpair33";
  attribute SOFT_HLUTNM of \brgen_counter[1]_i_1\ : label is "soft_lutpair33";
  attribute SOFT_HLUTNM of \brgen_counter[2]_i_1\ : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of \brgen_counter[3]_i_1\ : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of \brgen_counter[4]_i_2\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \ones[0]_i_4\ : label is "soft_lutpair32";
  attribute SOFT_HLUTNM of \ones[0]_i_5\ : label is "soft_lutpair32";
  attribute SOFT_HLUTNM of out_data_i_5 : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of parity_bit_i_3 : label is "soft_lutpair30";
begin
  SR(0) <= \^sr\(0);
...
receiver_1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver
     port map (
      ...
      SR(0) => transmitter_1_n_1,
      axi_aclk => axi_aclk,
      baud_pulse_reg => \test_reg_reg[8]\(0),
      brd_out => brd_out,
      brgen_prev => brgen_prev,
