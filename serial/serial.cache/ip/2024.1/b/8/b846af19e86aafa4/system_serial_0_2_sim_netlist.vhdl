...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_brd is
  ...
  attribute SOFT_HLUTNM of \latched_data[3]_i_2\ : label is "soft_lutpair0";
begin
  brd_out <= \^brd_out\;
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9 is
  port (
    ...
    empty : out STD_LOGIC;
    \watermark_reg[4]_0\ : out STD_LOGIC_VECTOR ( 4 downto 0 );
    axi_aclk : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9 is
  ...
  signal \^overflow_reg_0\ : STD_LOGIC;
  ...
  signal \^watermark_reg[4]_0\ : STD_LOGIC_VECTOR ( 4 downto 0 );
...
begin
  ...
  \watermark_reg[4]_0\(4 downto 0) <= \^watermark_reg[4]_0\(4 downto 0);
...
fifo_reg_0_15_0_5: unisim.vcomponents.RAM32M
     port map (
      ...
      DIA(1 downto 0) => \axi_rdata_reg[7]\(1 downto 0),
      DIB(1 downto 0) => \axi_rdata_reg[7]\(3 downto 2),
      DIC(1 downto 0) => \axi_rdata_reg[7]\(5 downto 4),
      DID(1 downto 0) => B"00",
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  port (
    ...
    \latched_data_reg[7]_0\ : out STD_LOGIC_VECTOR ( 7 downto 0 );
    axi_aclk : in STD_LOGIC;
    SR : in STD_LOGIC_VECTOR ( 0 to 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  ...
  signal \^latched_data_reg[7]_0\ : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal \^ok_to_write_rx\ : STD_LOGIC;
  signal \ones[0]_i_1__0_n_0\ : STD_LOGIC;
  signal \ones[0]_i_3__0_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of bit_a_i_2 : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \brgen_counter[0]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \brgen_counter[1]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \brgen_counter[2]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \brgen_counter[3]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \brgen_counter[4]_i_2\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \brgen_counter[4]_i_3\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of frame_error_i_2 : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \latched_data[0]_i_3\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \latched_data[2]_i_2\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \latched_data[6]_i_2\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \latched_data[6]_i_3\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \latched_data[7]_i_1\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \latched_data[7]_i_3\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \ones[0]_i_2\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \ones[0]_i_3__0\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \parity_bit_i_1__0\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \state[0]_i_4\ : label is "soft_lutpair21";
...
begin
  ...
  \latched_data_reg[7]_0\(7 downto 0) <= \^latched_data_reg[7]_0\(7 downto 0);
...
bit_c_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0010"
    )
        port map (
...
\latched_data[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFB0008"
    )
        port map (
      ...
      I4 => \^latched_data_reg[7]_0\(0),
      O => \latched_data[0]_i_1_n_0\
    );
\latched_data[0]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFDFFFFF"
    )
        port map (
...
\latched_data[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \state_reg_n_0_[2]\,
      I4 => \state_reg_n_0_[3]\,
      I5 => \^latched_data_reg[7]_0\(1),
      O => \latched_data[1]_i_1_n_0\
    );
\latched_data[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFBF0080"
    )
        port map (
      ...
      I2 => \state_reg_n_0_[2]\,
      I3 => \latched_data[2]_i_3_n_0\,
      I4 => \^latched_data_reg[7]_0\(2),
...
\latched_data[3]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFEF0020"
    )
        port map (
      I0 => p_7_in(0),
      I1 => \latched_data_reg[3]_0\,
      I2 => \brgen_counter_reg_n_0_[4]\,
      I3 => \latched_data[3]_i_3_n_0\,
      I4 => \^latched_data_reg[7]_0\(3),
...
\latched_data[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \state_reg_n_0_[0]\,
      I3 => bit_in,
      I4 => \latched_data[4]_i_2_n_0\,
      I5 => \^latched_data_reg[7]_0\(4),
...
\latched_data[5]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"08000000"
    )
        port map (
...
\latched_data[6]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \state_reg_n_0_[1]\,
      I4 => \latched_data_reg[6]_0\,
      I5 => \^latched_data_reg[7]_0\(6),
...
\latched_data[6]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFDFFF"
    )
        port map (
...
\latched_data[7]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I1 => \state_reg_n_0_[0]\,
      I2 => \state_reg_n_0_[1]\,
      I3 => \latched_data_reg[3]_0\,
      I4 => wr_request_i_2_n_0,
      I5 => \latched_data[7]_i_3_n_0\,
      O => \latched_data[7]_i_2_n_0\
    );
\latched_data[7]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\latched_data_reg[7]\: unisim.vcomponents.FDRE
     port map (
      ...
      Q => \^latched_data_reg[7]_0\(7),
      R => '0'
    );
\ones[0]_i_1__0\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"220F2F0F88008000"
    )
        port map (
...
\ones[0]_i_3__0\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"36"
    )
        port map (
...
wr_request_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"DF"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter is
  ...
  attribute SOFT_HLUTNM of \brgen_counter[4]_i_2\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \ones[0]_i_2__0\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \ones[0]_i_4\ : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of out_data_i_4 : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of out_data_i_5 : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of out_data_i_6 : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of out_data_i_7 : label is "soft_lutpair26";
...
out_data_i_5: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  port (
    \latched_data_reg[7]\ : out STD_LOGIC_VECTOR ( 7 downto 0 );
    wr_index : out STD_LOGIC_VECTOR ( 4 downto 0 );
    ADDRA : out STD_LOGIC_VECTOR ( 3 downto 0 );
    \watermark_reg[4]\ : out STD_LOGIC_VECTOR ( 4 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  ...
  signal \^latched_data_reg[7]\ : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal ok_to_read_tx : STD_LOGIC;
...
begin
  ...
  empty <= \^empty\;
  \latched_data_reg[7]\(7 downto 0) <= \^latched_data_reg[7]\(7 downto 0);
...
fifo_rx: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9
     port map (
      ...
      \axi_rdata_reg[7]\(7 downto 0) => \^latched_data_reg[7]\(7 downto 0),
      empty => \^empty\,
      fe_out => fe_out,
      ...
      status(0) => status(2),
      \watermark_reg[4]_0\(4 downto 0) => \watermark_reg[4]\(4 downto 0)
    );
...
receiver_1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver
     port map (
      ...
      \latched_data_reg[3]_0\ => baudRateDivider_n_1,
      \latched_data_reg[6]_0\ => transmitter_1_n_5,
      \latched_data_reg[7]_0\(7 downto 0) => \^latched_data_reg[7]\(7 downto 0),
      ok_to_write_rx => ok_to_write_rx,
      parity_error => parity_error,
...
serial_v1_0_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI
     port map (
      ...
      rx_in => rx_in,
      tx_out => tx_out,
      \watermark_reg[4]\(4 downto 0) => \watermark_reg[4]\(4 downto 0),
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial
     port map (
      ...
      clk_out => clk_out,
      empty => empty,
      \latched_data_reg[7]\(7 downto 0) => \^rd_data\(7 downto 0),
      ...
      rx_in => rx_in,
      tx_out => tx_out,
      \watermark_reg[4]\(4 downto 0) => watermark(4 downto 0),
      wr_index(4 downto 0) => wr_index(4 downto 0)
    );
end STRUCTURE;
