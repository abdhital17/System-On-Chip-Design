...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detector_0 is
  ...
  signal \^wr\ : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of previous_state_i_1 : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of pulse_i_1 : label is "soft_lutpair15";
begin
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9 is
  ...
  signal \^rd_index_reg[4]_2\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \axi_rdata[27]_i_1\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of empty_INST_0_i_1 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of empty_INST_0_i_2 : label is "soft_lutpair4";
  ...
  attribute SOFT_HLUTNM of full_INST_0_i_1 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \rd_index[1]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \rd_index[2]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \rd_index[3]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \rd_index[4]_i_2\ : label is "soft_lutpair5";
  ...
  attribute SOFT_HLUTNM of \wr_index[4]_i_3\ : label is "soft_lutpair6";
begin
  ...
  \rd_index_reg[4]_2\ <= \^rd_index_reg[4]_2\;
...
empty_INST_0_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFF6FF6"
    )
        port map (
...
full_INST_0_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EB"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_onehot_state[10]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \FSM_onehot_state[11]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \FSM_onehot_state[12]_i_3\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \brgen_counter[4]_i_3\ : label is "soft_lutpair12";
begin
...
fifo1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9
     port map (
      ...
      D(1) => fifo1_n_36,
      D(0) => fifo1_n_37,
      E(0) => write_request_detector_n_3,
