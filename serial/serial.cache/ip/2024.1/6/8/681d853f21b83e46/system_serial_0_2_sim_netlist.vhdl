...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9_0 is
  ...
  signal \watermark_reg_n_0_[0]\ : STD_LOGIC;
  signal \watermark_reg_n_0_[1]\ : STD_LOGIC;
  signal \watermark_reg_n_0_[2]\ : STD_LOGIC;
  signal \watermark_reg_n_0_[3]\ : STD_LOGIC;
  signal \watermark_reg_n_0_[4]\ : STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter is
  ...
  attribute SOFT_HLUTNM of baud_en : label is "soft_lutpair18";
  ...
  attribute SOFT_HLUTNM of rd_request_i_2 : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of rd_request_i_3 : label is "soft_lutpair17";
begin
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  ...
  signal \control_reg_n_0_[5]\ : STD_LOGIC;
  ...
  signal write_request_detector_tx_n_5 : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  ...
  attribute SOFT_HLUTNM of \status[5]_i_2\ : label is "soft_lutpair24";
...
baudRateDivider: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_brd
     port map (
      ...
      clk_out => clk_out,
      clk_out_0(1) => \control_reg_n_0_[5]\,
...
fifo_rx: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9
     port map (
      ...
      D(1) => fifo_rx_n_29,
      D(0) => fifo_rx_n_30,
      E(0) => write_request_detector_tx_n_5,
      ...
      \rd_index_reg[4]_1\ => write_request_detector_tx_n_4,
      watermark(4 downto 0) => watermark(4 downto 0),
...
fifo_tx: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9_0
     port map (
      ...
      \axi_rdata_reg[20]\(2) => \control_reg_n_0_[5]\,
...
write_request_detector_tx: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detector_2
     port map (
      ...
      pulse_reg_1 => write_request_detector_tx_n_4,
      pulse_reg_2 => \^s_axi_awready\,
      pulse_reg_3 => \^s_axi_wready\,
      \rd_index_reg[4]\ => \status_reg_n_0_[2]\,
      read_en => read_en,
      \status_reg[2]\(0) => write_request_detector_tx_n_5,
      tx_empty => tx_empty,
      wr => wr,
