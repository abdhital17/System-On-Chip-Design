...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_brd is
  ...
  attribute SOFT_HLUTNM of \test_reg[1]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \test_reg_reg[7]_i_2\ : label is "soft_lutpair0";
begin
  brd_out <= \^brd_out\;
...
\test_reg[1]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"DF"
    )
        port map (
...
\test_reg_reg[7]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detector_3 is
  ...
  signal \^wr\ : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of previous_state_i_1 : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of pulse_i_1 : label is "soft_lutpair31";
begin
  wr <= \^wr\;
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  port (
    baud_pulse_reg : out STD_LOGIC_VECTOR ( 5 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  ...
  signal \^baud_pulse_reg\ : STD_LOGIC_VECTOR ( 5 downto 0 );
  ...
  signal \parity_bit_i_2__0_n_0\ : STD_LOGIC;
  ...
  signal \test_reg[2]_i_2_n_0\ : STD_LOGIC;
  signal \test_reg[5]_i_1_n_0\ : STD_LOGIC;
  signal \test_reg[6]_i_1_n_0\ : STD_LOGIC;
  signal \test_reg[6]_i_2_n_0\ : STD_LOGIC;
  signal \test_reg[6]_i_3_n_0\ : STD_LOGIC;
  ...
  signal \test_reg_reg[7]_i_1_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_state[0]_i_4__0\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \FSM_sequential_state[0]_i_6__0\ : label is "soft_lutpair23";
  ...
  attribute SOFT_HLUTNM of \brgen_counter_reg[0]_i_1\ : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of \latched_data[0]_i_2\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \latched_data[1]_i_2\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \latched_data[3]_i_2\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \latched_data[4]_i_2\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \latched_data[7]_i_2\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \ones[0]_i_2__0\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \parity_bit_i_2__0\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \test_reg[0]_i_2\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \test_reg[6]_i_2\ : label is "soft_lutpair19";
  ...
  attribute SOFT_HLUTNM of \test_reg_reg[3]_i_2\ : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of wr_request_i_2 : label is "soft_lutpair18";
begin
  baud_pulse_reg(5 downto 0) <= \^baud_pulse_reg\(5 downto 0);
...
\FSM_sequential_state[3]_i_1__0\: unisim.vcomponents.LUT6
    generic map(
      ...
      I5 => \test_reg_reg[3]_i_2_n_0\,
      O => \FSM_sequential_state[3]_i_1__0_n_0\
    );
\FSM_sequential_state[3]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000C8C8FF3F0000"
    )
        port map (
...
\latched_data[1]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\latched_data[3]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"DF"
    )
        port map (
...
\latched_data[7]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\ones[0]_i_1__0\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"F4F7F4FF08080800"
    )
        port map (
      I0 => \^test_reg_reg[3]_i_1_0\,
      I1 => \ones[0]_i_2__0_n_0\,
      I2 => \test_reg_reg[0]_0\,
      I3 => \test_reg_reg[3]_i_2_n_0\,
      I4 => \FSM_sequential_state[3]_i_4_n_0\,
      I5 => \ones_reg_n_0_[0]\,
...
\parity_bit_i_2__0\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"80000000"
    )
        port map (
...
\test_reg[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFF300000004"
    )
        port map (
      I0 => \state__0\(3),
      I1 => \state__0\(0),
...
\test_reg[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => \test_reg_reg[0]_0\,
      I5 => \state__0\(3),
      O => \test_reg[2]_i_2_n_0\
    );
\test_reg[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0200FFFF02000000"
    )
        port map (
      I0 => \test_reg[6]_i_2_n_0\,
      I1 => \state__0\(1),
      I2 => \state__0\(3),
      I3 => in_prev_reg_n_0,
      I4 => \test_reg[6]_i_3_n_0\,
      I5 => \^baud_pulse_reg\(3),
      O => \test_reg[5]_i_1_n_0\
    );
\test_reg[6]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0200FFFF02000000"
    )
        port map (
...
\test_reg[6]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"45"
    )
        port map (
      ...
      I1 => \state__0\(1),
      I2 => \state__0\(0),
      O => \test_reg[6]_i_2_n_0\
    );
\test_reg[6]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0800"
    )
        port map (
...
\test_reg_reg[7]\: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
        ...
        port map (
      CLR => '0',
      D => \test_reg_reg[7]_i_1_n_0\,
      G => E(0),
      GE => '1',
      Q => \^baud_pulse_reg\(5)
    );
\test_reg_reg[7]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => \^baud_pulse_reg\(5),
      O => \test_reg_reg[7]_i_1_n_0\
    );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter is
  ...
  attribute SOFT_HLUTNM of \brgen_counter[0]_i_1\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of \brgen_counter[1]_i_1\ : label is "soft_lutpair30";
  ...
  attribute SOFT_HLUTNM of \ones[0]_i_4\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \ones[0]_i_5\ : label is "soft_lutpair29";
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  ...
  signal receiver_1_n_10 : STD_LOGIC;
  signal receiver_1_n_11 : STD_LOGIC;
  signal receiver_1_n_12 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \raddr[3]_i_1\ : label is "soft_lutpair32";
begin
...
receiver_1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver
     port map (
      E(0) => test_reg1,
      \FSM_sequential_state_reg[0]_0\ => transmitter_1_n_5,
      \FSM_sequential_state_reg[0]_1\ => transmitter_1_n_4,
      \FSM_sequential_state_reg[3]_0\ => transmitter_1_n_6,
      Q(4) => in6,
      ...
      rx_in => rx_in,
      \status_reg[6]\ => receiver_1_n_10,
      \status_reg[7]\ => receiver_1_n_11,
      \test_reg_reg[0]_0\ => baudRateDivider_n_1,
      \test_reg_reg[3]_i_1_0\ => \test_reg_reg[3]_i_1\,
      wr_request_reg_0 => receiver_1_n_12
    );
...
transmitter_1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter
     port map (
      ...
      \control_reg[0]\ => transmitter_1_n_6,
...
begin
  ...
  axi_rresp(0) <= \<const0>\;
  rd_data(8) <= \<const0>\;
  rd_data(7 downto 5) <= \^rd_data\(7 downto 5);
  rd_data(4) <= \<const0>\;
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial
     port map (
      ...
      axi_wstrb(3 downto 0) => axi_wstrb(3 downto 0),
      axi_wvalid => axi_wvalid,
      baud_pulse_reg(5 downto 3) => \^rd_data\(7 downto 5),
      baud_pulse_reg(2 downto 0) => \^rd_data\(2 downto 0),
      clk_out => clk_out,
      empty => empty,
      overflow => overflow,
