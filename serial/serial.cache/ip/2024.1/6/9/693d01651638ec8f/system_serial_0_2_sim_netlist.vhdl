...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_brd is
  ...
  attribute SOFT_HLUTNM of \brgen_counter[3]_i_3\ : label is "soft_lutpair0";
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  ...
  signal \test_reg[2]_i_3_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of bit_b_i_2 : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of bit_c_i_2 : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \brgen_counter[0]_i_1\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \brgen_counter[1]_i_1\ : label is "soft_lutpair27";
  ...
  attribute SOFT_HLUTNM of \brgen_counter[3]_i_4\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of frame_error_i_2 : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \latched_data[0]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \latched_data[2]_i_1\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \latched_data[4]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \latched_data[6]_i_1\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \latched_data[7]_i_2\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \ones[0]_i_2__0\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of parity_error_i_3 : label is "soft_lutpair19";
  ...
  attribute SOFT_HLUTNM of \state[3]_i_4\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \test_reg[0]_i_2\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \test_reg[2]_i_2\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \test_reg[7]_i_2\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \test_reg[8]_i_2\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \test_reg[8]_i_3\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of wr_request_i_3 : label is "soft_lutpair19";
begin
...
bit_a_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFE0002"
    )
        port map (
...
bit_b_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0010"
    )
        port map (
...
\brgen_counter[3]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\latched_data[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FE02"
    )
        port map (
...
\latched_data[4]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FB08"
    )
        port map (
...
\test_reg[2]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
\test_reg[4]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B4"
    )
        port map (
...
wr_request_i_3: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0080"
    )
        port map (
...
wr_request_i_4: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
receiver_1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver
     port map (
      ...
      axi_aclk => axi_aclk,
      axi_aresetn => axi_aresetn,
      bit_a_reg_0 => baudRateDivider_n_1,
      brd_out => brd_out,
      brgen_prev => brgen_prev,
      data(7 downto 0) => data(7 downto 0),
      fe_out => fe_out,
      ...
      wr_request_reg_1 => transmitter_1_n_5
    );
