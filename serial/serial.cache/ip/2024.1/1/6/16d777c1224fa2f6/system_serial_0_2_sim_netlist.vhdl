...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detector_3 is
  ...
  signal \^wr\ : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of previous_state_i_1 : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of pulse_i_1 : label is "soft_lutpair21";
begin
  wr <= \^wr\;
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  port (
    ...
    \test_reg_reg[5]_0\ : out STD_LOGIC_VECTOR ( 2 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  ...
  signal \^test_reg_reg[5]_0\ : STD_LOGIC_VECTOR ( 2 downto 0 );
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \pulse_i_1__2\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of wr_request_i_1 : label is "soft_lutpair14";
begin
  frame_error <= \^frame_error\;
  ok_to_write_rx <= \^ok_to_write_rx\;
  parity_error <= \^parity_error\;
  \test_reg_reg[5]_0\(2 downto 0) <= \^test_reg_reg[5]_0\(2 downto 0);
...
\FSM_sequential_state_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => axi_aclk,
      CE => \FSM_sequential_state[0]_i_1__0_n_0\,
      D => \state__0\(0),
      Q => state(0),
      R => SR(0)
    );
...
wr_request_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FB00"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter is
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_state[0]_i_7\ : label is "soft_lutpair15";
  attribute FSM_ENCODED_STATES : string;
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[0]\ : label is "D2:0100,D1:0011,D0:0010,STOP2:1100,STOP1:1011,P:1010,START:0001,IDLE:0000,D5:0111,D7:1001,D4:0110,D6:1000,D3:0101";
  ...
  attribute SOFT_HLUTNM of baud_en : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \brgen_counter[0]_i_1\ : label is "soft_lutpair20";
  ...
  attribute SOFT_HLUTNM of \ones[0]_i_4\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \ones[0]_i_5\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of out_data_i_5 : label is "soft_lutpair15";
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  port (
    \test_reg_reg[5]\ : out STD_LOGIC_VECTOR ( 2 downto 0 );
...
receiver_1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver
     port map (
      ...
      rx_in => rx_in,
      \status_reg[6]\ => receiver_1_n_6,
      \status_reg[7]\ => receiver_1_n_7,
      \test_reg_reg[5]_0\(2 downto 0) => \test_reg_reg[5]\(2 downto 0),
      wr_request_reg_0 => receiver_1_n_8
    );
...
serial_v1_0_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI
     port map (
      ...
      rx_in => rx_in,
      \test_reg_reg[5]\(2 downto 0) => \test_reg_reg[5]\(2 downto 0),
      tx_out => tx_out,
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial
     port map (
      ...
      rx_in => rx_in,
      \test_reg_reg[5]\(2 downto 1) => \^rd_data\(5 downto 4),
      \test_reg_reg[5]\(0) => \^rd_data\(0),
      tx_out => tx_out,
