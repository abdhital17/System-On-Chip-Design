...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detector is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \axi_rdata[31]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \pulse_i_1__0\ : label is "soft_lutpair15";
begin
  E(0) <= \^e\(0);
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9_0 is
  port (
    ...
    p_0_in_0 : in STD_LOGIC_VECTOR ( 1 downto 0 );
    \axi_rdata_reg[20]\ : in STD_LOGIC_VECTOR ( 8 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9_0 is
  ...
  signal NLW_fifo_reg_0_15_6_8_DOD_UNCONNECTED : STD_LOGIC_VECTOR ( 1 downto 0 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \axi_rdata[3]_i_2\ : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \watermark[0]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \watermark[1]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \watermark[3]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \watermark[4]_i_1\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \wr_index[3]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \wr_index[4]_i_2__0\ : label is "soft_lutpair10";
begin
  tx_empty <= \^tx_empty\;
  tx_full <= \^tx_full\;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  ...
  signal baud_en_i_4_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of baud_en_i_2 : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of baud_en_i_4 : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of \brgen_counter[4]_i_1\ : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of \test[8]_i_2\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of wr_request_i_3 : label is "soft_lutpair18";
begin
  ok_to_write_rx <= \^ok_to_write_rx\;
  \test_reg[8]_0\(7 downto 0) <= \^test_reg[8]_0\(7 downto 0);
baud_en_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000AA003000AA00"
    )
        port map (
      I0 => baud_en,
      I1 => baud_en_i_2_n_0,
...
baud_en_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
baud_en_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
baud_en_i_4: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00114000"
    )
        port map (
...
\test[1]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B4"
    )
        port map (
...
\test[8]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter is
  ...
  attribute SOFT_HLUTNM of \brgen_counter[3]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \brgen_counter[4]_i_2\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of rd_request_i_2 : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of rd_request_i_3 : label is "soft_lutpair22";
begin
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  ...
  attribute SOFT_HLUTNM of \status[5]_i_2\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of write_en_i_1 : label is "soft_lutpair29";
begin
...
fifo_tx: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9_0
     port map (
      ...
      axi_aclk => axi_aclk,
      axi_aresetn => axi_aresetn,
      \axi_rdata_reg[20]\(8) => \control_reg_n_0_[20]\,
      \axi_rdata_reg[20]\(7) => \control_reg_n_0_[19]\,
      \axi_rdata_reg[20]\(6) => \control_reg_n_0_[18]\,
      \axi_rdata_reg[20]\(5) => \control_reg_n_0_[17]\,
      \axi_rdata_reg[20]\(4) => \control_reg_n_0_[16]\,
      \axi_rdata_reg[20]\(3) => data50,
...
transmitter_1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter
     port map (
      ...
      \FSM_sequential_state_reg[2]_0\(2 downto 0) => \state__0\(2 downto 0),
      Q(4) => data50,
      Q(3) => \control_reg_n_0_[3]\,
      Q(2) => \control_reg_n_0_[2]\,
      Q(1) => \control_reg_n_0_[1]\,
