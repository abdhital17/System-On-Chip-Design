...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9 is
  ...
  attribute SOFT_HLUTNM of \watermark[3]_i_1__0\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \watermark[4]_i_1__0\ : label is "soft_lutpair1";
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9_0 is
  ...
  attribute SOFT_HLUTNM of \watermark[3]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \watermark[4]_i_1\ : label is "soft_lutpair7";
  ...
  attribute SOFT_HLUTNM of \wr_index[4]_i_2__0\ : label is "soft_lutpair8";
begin
  \rd_index_reg[0]_0\ <= \^rd_index_reg[0]_0\;
  \rd_index_reg[3]_0\ <= \^rd_index_reg[3]_0\;
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  port (
    ...
    \brgen_counter_reg[0]_0\ : in STD_LOGIC;
    axi_aresetn : in STD_LOGIC;
    brd_out : in STD_LOGIC;
    brgen_prev : in STD_LOGIC;
    \state_reg[3]_0\ : in STD_LOGIC_VECTOR ( 4 downto 0 );
    rx_in : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  ...
  signal \test_reg[7]_i_3_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \brgen_counter[0]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \brgen_counter[1]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \brgen_counter[2]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \brgen_counter[3]_i_2\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of in_prev_i_2 : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \latched_data[2]_i_2\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \latched_data[3]_i_1\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \latched_data[4]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \latched_data[7]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \ones[0]_i_2\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of parity_error_i_5 : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of parity_error_i_6 : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \state[0]_i_3\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \state[1]_i_3\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \state[2]_i_2\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \state[3]_i_4\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \test_reg[0]_i_2\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \test_reg[3]_i_1\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \test_reg[3]_i_3\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \test_reg[3]_i_4\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \test_reg[4]_i_3\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \test_reg[4]_i_4\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \test_reg[7]_i_3\ : label is "soft_lutpair15";
...
bit_b_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFB0008"
    )
        port map (
...
\latched_data[0]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => \state_reg_n_0_[2]\,
      I1 => \brgen_counter_reg_n_0_[2]\,
      I2 => \test_reg[4]_i_3_n_0\,
      I3 => axi_aresetn,
      I4 => \state_reg_n_0_[1]\,
      I5 => \latched_data[2]_i_2_n_0\,
      O => \latched_data[0]_i_2_n_0\
    );
\latched_data[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFB0008"
    )
        port map (
...
parity_error_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"57FF030354000000"
    )
        port map (
      I0 => parity_error_i_2_n_0,
      I1 => in_prev17_out,
      I2 => parity_error_i_4_n_0,
      I3 => parity_error_i_5_n_0,
      I4 => \test_reg[0]_i_2_n_0\,
      I5 => \^parity_error\,
      O => parity_error_i_1_n_0
    );
parity_error_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FBEFEFFB"
    )
        port map (
      I0 => parity_error_i_6_n_0,
      I1 => \state_reg[3]_0\(2),
      I2 => \state_reg[3]_0\(3),
      I3 => parity_bit,
      I4 => p_0_in(0),
...
\state[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => in_prev_reg_n_0,
      I4 => rx_in,
      I5 => \test_reg[0]_i_2_n_0\,
      O => \state[0]_i_1_n_0\
    );
\state[0]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00001111FFFFFF1F"
    )
        port map (
      I0 => \state_reg[3]_0\(2),
      I1 => \state_reg[3]_0\(3),
...
\test_reg[0]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
\test_reg[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \state_reg_n_0_[2]\,
      I3 => \brgen_counter_reg_n_0_[2]\,
      I4 => \test_reg[6]_i_2_n_0\,
      I5 => \^test_reg_reg[8]_0\(2),
      O => \test_reg[2]_i_1_n_0\
    );
\test_reg[3]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
      I0 => \test_reg[3]_i_2_n_0\,
      I1 => \^test_reg_reg[8]_0\(3),
      O => \test_reg[3]_i_1_n_0\
    );
\test_reg[3]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"2000000000000000"
    )
        port map (
      I0 => \test_reg[3]_i_3_n_0\,
      I1 => \test_reg[3]_i_4_n_0\,
      I2 => \^q\(0),
      I3 => \brgen_counter_reg_n_0_[2]\,
      I4 => axi_aresetn,
      I5 => \state_reg_n_0_[0]\,
...
\test_reg[3]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
\test_reg[4]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0040000000000000"
        ...
        port map (
      I0 => \test_reg[4]_i_3_n_0\,
      I1 => brgen_counter0,
      I2 => \brgen_counter_reg_n_0_[3]\,
      I3 => \test_reg[4]_i_4_n_0\,
      I4 => axi_aresetn,
      I5 => \state_reg_n_0_[1]\,
      O => \test_reg[4]_i_2_n_0\
    );
\test_reg[4]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\test_reg[4]_i_4\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"EFFF"
    )
        port map (
...
\test_reg[6]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\test_reg[7]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"08000000"
    )
        port map (
...
\test_reg[8]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter is
  port (
    ...
    brgen_prev_reg_1 : out STD_LOGIC;
    ...
    bit_c_reg : in STD_LOGIC_VECTOR ( 0 to 0 );
    previous_state : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter is
  ...
  attribute SOFT_HLUTNM of bit_c_i_2 : label is "soft_lutpair32";
  attribute SOFT_HLUTNM of \brgen_counter[0]_i_1__0\ : label is "soft_lutpair34";
  ...
  attribute SOFT_HLUTNM of \brgen_counter[3]_i_3\ : label is "soft_lutpair32";
  attribute SOFT_HLUTNM of \brgen_counter[4]_i_2\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of \ones[0]_i_2__0\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of out_data_i_4 : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of out_data_i_5 : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of out_data_i_6 : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of out_data_i_7 : label is "soft_lutpair27";
...
\brgen_counter[3]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"40"
    )
        port map (
...
receiver_1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver
     port map (
      ...
      axi_aclk => axi_aclk,
      axi_aresetn => axi_aresetn,
      bit_c_reg_0 => transmitter_1_n_5,
      brd_out => brd_out,
      brgen_counter0 => brgen_counter0,
      \brgen_counter_reg[0]_0\ => transmitter_1_n_4,
      brgen_prev => brgen_prev,
      data(7 downto 0) => data(7 downto 0),
      fe_out => fe_out,
      ...
      rx_in => rx_in,
      \state_reg[3]_0\(4) => data50,
      \state_reg[3]_0\(3) => \control_reg_n_0_[3]\,
      \state_reg[3]_0\(2) => \control_reg_n_0_[2]\,
      \state_reg[3]_0\(1) => \control_reg_n_0_[1]\,
      \state_reg[3]_0\(0) => \control_reg_n_0_[0]\,
      \status_reg[6]\ => receiver_1_n_4,
      \status_reg[7]\ => receiver_1_n_5,
      \test_reg_reg[8]_0\(8 downto 0) => \test_reg_reg[8]\(8 downto 0),
      wr_request_reg_0 => receiver_1_n_6
    );
...
transmitter_1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter
     port map (
      ...
      axi_aclk => axi_aclk,
      axi_aresetn => axi_aresetn,
      bit_c_reg(0) => receiver_1_n_3,
      brd_out => brd_out,
      brgen_prev => brgen_prev,
      brgen_prev_reg_0 => transmitter_1_n_4,
      brgen_prev_reg_1 => transmitter_1_n_5,
      ok_to_read_tx => ok_to_read_tx,
      previous_state => previous_state,
