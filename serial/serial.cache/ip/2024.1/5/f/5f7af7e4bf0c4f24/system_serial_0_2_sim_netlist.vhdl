...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  ...
  attribute SOFT_HLUTNM of bit_c_i_2 : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \brgen_counter[1]_i_1\ : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of \brgen_counter[3]_i_3\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of in_prev_i_1 : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \latched_data[4]_i_2\ : label is "soft_lutpair18";
  ...
  attribute SOFT_HLUTNM of \latched_data[7]_i_3\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \state[0]_i_7\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \state[1]_i_4\ : label is "soft_lutpair22";
  ...
  attribute SOFT_HLUTNM of \state[3]_i_5\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \test[7]_i_2\ : label is "soft_lutpair14";
begin
...
\latched_data[3]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FB08"
    )
        port map (
...
\test[7]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"DFFFFFFF"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter is
  ...
  attribute SOFT_HLUTNM of out_data_i_6 : label is "soft_lutpair26";
...
out_data_i_6: unisim.vcomponents.LUT3
    generic map(
      INIT => X"04"
    )
        port map (
...
receiver_1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver
     port map (
      ...
      bit_in_reg_0 => transmitter_1_n_3,
      brd_out => brd_out,
      brgen_prev => brgen_prev,
      ok_to_write_rx => ok_to_write_rx,
      p_0_in_0(1 downto 0) => p_0_in_0(1 downto 0),
