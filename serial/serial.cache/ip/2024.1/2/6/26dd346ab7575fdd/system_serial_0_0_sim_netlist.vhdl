...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  ...
  signal status : STD_LOGIC_VECTOR ( 26 to 26 );
  signal \status[26]_i_1_n_0\ : STD_LOGIC;
  signal \status[26]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \status[26]_i_2\ : label is "soft_lutpair11";
...
\status[26]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\status[26]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
