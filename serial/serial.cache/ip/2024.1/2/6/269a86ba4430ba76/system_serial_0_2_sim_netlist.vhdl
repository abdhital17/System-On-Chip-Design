...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  port (
    ...
    \test_reg[8]_0\ : out STD_LOGIC_VECTOR ( 8 downto 0 );
    axi_aclk : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  ...
  signal \test[2]_i_3_n_0\ : STD_LOGIC;
  ...
  signal \^test_reg[8]_0\ : STD_LOGIC_VECTOR ( 8 downto 0 );
  ...
  attribute SOFT_HLUTNM of \state[0]_i_10\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \state[0]_i_11\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \state[0]_i_5\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \state[0]_i_6\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \state[0]_i_7\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \state[0]_i_8\ : label is "soft_lutpair19";
  ...
  attribute SOFT_HLUTNM of \test[2]_i_3\ : label is "soft_lutpair15";
begin
  ok_to_write_rx <= \^ok_to_write_rx\;
  \test_reg[8]_0\(8 downto 0) <= \^test_reg[8]_0\(8 downto 0);
...
\brgen_counter[3]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\test[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FB08"
    )
        port map (
...
\test[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FBFF0400"
    )
        port map (
...
\test[2]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\test[2]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  port (
    ...
    \test_reg[8]\ : out STD_LOGIC_VECTOR ( 8 downto 0 );
    watermark : out STD_LOGIC_VECTOR ( 4 downto 0 );
...
receiver_1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver
     port map (
      ...
      \test_reg[8]_0\(8 downto 0) => \test_reg[8]\(8 downto 0),
...
serial_v1_0_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI
     port map (
      ...
      rx_in => rx_in,
      \test_reg[8]\(8 downto 0) => \test_reg[8]\(8 downto 0),
      tx_out => tx_out,
      watermark(4 downto 0) => watermark(4 downto 0),
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial
     port map (
      ...
      rx_in => rx_in,
      \test_reg[8]\(8 downto 0) => rd_data(8 downto 0),
      tx_out => tx_out,
      watermark(4 downto 0) => watermark(4 downto 0),
      wr_index(4 downto 0) => wr_index(4 downto 0)
    );
