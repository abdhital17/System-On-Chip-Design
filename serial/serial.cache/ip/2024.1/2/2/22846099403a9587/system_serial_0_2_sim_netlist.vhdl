...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detector_3 is
  ...
  signal \^wr\ : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of previous_state_i_1 : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of pulse_i_1 : label is "soft_lutpair23";
begin
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  ...
  attribute SOFT_HLUTNM of \test[7]_i_2\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \test[8]_i_3\ : label is "soft_lutpair15";
...
\test[3]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\test[6]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\test[8]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"20000000"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter is
  ...
  attribute SOFT_HLUTNM of out_data_i_7 : label is "soft_lutpair21";
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  ...
  attribute SOFT_HLUTNM of \status[5]_i_2\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of write_en_i_1 : label is "soft_lutpair25";
begin
...
transmitter_1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter
     port map (
      ...
      \FSM_sequential_state_reg[0]_4\ => receiver_1_n_1,
      Q(4) => data50,
      Q(3) => \control_reg_n_0_[3]\,
      Q(2) => \control_reg_n_0_[2]\,
      Q(1) => \control_reg_n_0_[1]\,
...
begin
  ...
  axi_rresp(1) <= \<const0>\;
  axi_rresp(0) <= \<const0>\;
  rd_data(8 downto 3) <= \^rd_data\(8 downto 3);
  rd_data(2) <= \<const0>\;
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial
     port map (
      ...
      \test_reg[8]\(7 downto 2) => \^rd_data\(8 downto 3),
