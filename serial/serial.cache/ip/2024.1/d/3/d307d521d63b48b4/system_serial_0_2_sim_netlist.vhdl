...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  ...
  signal pe_i_3_n_0 : STD_LOGIC;
  signal pe_i_4_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of bit_a_i_2 : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of bit_b_i_2 : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of bit_c_i_2 : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \brgen_counter[1]_i_1\ : label is "soft_lutpair21";
  ...
  attribute SOFT_HLUTNM of \brgen_counter[3]_i_4\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of fe_i_2 : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of pe_i_2 : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of pe_i_3 : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \state[0]_i_3\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \state[0]_i_6\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \state[0]_i_9\ : label is "soft_lutpair22";
  ...
  attribute SOFT_HLUTNM of \state[2]_i_3\ : label is "soft_lutpair23";
...
pe_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FF470044"
    )
        port map (
...
pe_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"DB"
    )
        port map (
...
pe_i_3: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00002000"
    )
        port map (
...
pe_i_4: unisim.vcomponents.LUT6
    generic map(
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter is
  ...
  attribute SOFT_HLUTNM of \FSM_onehot_state[11]_i_1\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \FSM_onehot_state[12]_i_2\ : label is "soft_lutpair25";
...
bit_in_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"40"
    )
        port map (
