...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detector_0 is
  ...
  attribute SOFT_HLUTNM of \pulse_i_1__0\ : label is "soft_lutpair7";
begin
  E(0) <= \^e\(0);
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detector_1 is
  ...
  attribute SOFT_HLUTNM of pulse_i_1 : label is "soft_lutpair8";
begin
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9 is
  ...
  attribute SOFT_HLUTNM of \rd_index_reg[4]_i_3\ : label is "soft_lutpair5";
...
fifo_reg_0_15_0_5: unisim.vcomponents.RAM32M
     port map (
      ADDRA(4) => '0',
      ADDRA(3) => \^wr_index_reg[3]_0\,
      ADDRA(2) => \^axi_aresetn_1\,
      ADDRA(1) => \^axi_aresetn_0\,
      ADDRA(0) => \^wr_index_reg[4]_0\,
      ADDRB(4) => '0',
      ADDRB(3) => \^wr_index_reg[3]_0\,
      ADDRB(2) => \^axi_aresetn_1\,
      ADDRB(1) => \^axi_aresetn_0\,
      ADDRB(0) => \^wr_index_reg[4]_0\,
      ADDRC(4) => '0',
      ADDRC(3) => \^wr_index_reg[3]_0\,
      ADDRC(2) => \^axi_aresetn_1\,
      ADDRC(1) => \^axi_aresetn_0\,
      ADDRC(0) => \^wr_index_reg[4]_0\,
      ADDRD(4) => '0',
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  ...
  attribute SOFT_HLUTNM of \raddr[3]_i_1\ : label is "soft_lutpair9";
begin
...
serial_v1_0_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI
     port map (
      ADDRA(3) => \wr_index_reg[3]\,
      ADDRA(2) => axi_aresetn_0,
      ADDRA(1) => axi_aresetn_1,
      ADDRA(0) => \wr_index_reg[4]\,
      S_AXI_ARREADY => S_AXI_ARREADY,
      S_AXI_AWREADY => S_AXI_AWREADY,
      S_AXI_WREADY => S_AXI_WREADY,
      axi_aclk => axi_aclk,
