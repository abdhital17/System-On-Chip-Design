...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  ...
  signal \brgen_counter[1]_i_2_n_0\ : STD_LOGIC;
  ...
  signal \test_reg[0]_i_3_n_0\ : STD_LOGIC;
  signal \test_reg[0]_i_4_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \brgen_counter[2]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \brgen_counter[3]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \brgen_counter[4]_i_3\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of frame_error_i_2 : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \latched_data[7]_i_2\ : label is "soft_lutpair20";
  ...
  attribute SOFT_HLUTNM of \state[2]_i_2\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \test_reg[0]_i_2\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \test_reg[0]_i_3\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \test_reg[0]_i_4\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \test_reg[1]_i_2\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \test_reg[4]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \test_reg[5]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \test_reg[5]_i_2\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \test_reg[8]_i_2\ : label is "soft_lutpair15";
begin
...
\brgen_counter[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\brgen_counter[1]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\brgen_counter_reg[1]\: unisim.vcomponents.FDRE
     port map (
      C => axi_aclk,
      CE => brgen_counter,
      D => \brgen_counter[1]_i_2_n_0\,
      Q => \brgen_counter_reg_n_0_[1]\,
      R => \brgen_counter[1]_i_1_n_0\
    );
...
\ones[0]_i_3__0\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"1114111700000000"
    )
        port map (
      I0 => \test_reg[0]_i_4_n_0\,
      I1 => \state_reg_n_0_[3]\,
...
parity_error_i_1: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0820FFFF08200000"
    )
        port map (
      I0 => \test_reg[8]_i_2_n_0\,
      I1 => Q(3),
      I2 => Q(2),
      I3 => parity_error0,
      I4 => parity_error_0,
...
parity_error_i_3: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0411000000110000"
    )
        port map (
      I0 => \state[1]_i_4_n_0\,
      I1 => \state_reg_n_0_[1]\,
      I2 => \test_reg[0]_i_4_n_0\,
      I3 => \state_reg_n_0_[3]\,
      I4 => brgen_counter,
      I5 => parity_error_i_4_n_0,
      O => parity_error_0
    );
parity_error_i_4: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
\state[0]_i_3\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \state_reg_n_0_[1]\,
      I4 => \state_reg_n_0_[3]\,
      I5 => \test_reg[0]_i_4_n_0\,
      O => \state[0]_i_3_n_0\
    );
\state[0]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"404000FF00000000"
    )
        port map (
      I0 => \state_reg_n_0_[3]\,
      I1 => \state[1]_i_5_n_0\,
...
\test_reg[0]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
      I0 => \state_reg_n_0_[0]\,
      I1 => \state_reg_n_0_[2]\,
      O => \test_reg[0]_i_3_n_0\
    );
\test_reg[0]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"DFFFFFFF"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter is
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_state[0]_i_12\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \FSM_sequential_state[0]_i_13\ : label is "soft_lutpair33";
  attribute SOFT_HLUTNM of \FSM_sequential_state[0]_i_2\ : label is "soft_lutpair29";
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_state[0]_i_9\ : label is "soft_lutpair23";
  ...
  attribute SOFT_HLUTNM of \ones[0]_i_3\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \ones[0]_i_4\ : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of \ones[0]_i_6\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of out_data_i_3 : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of out_data_i_6 : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of out_data_i_8 : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of out_data_i_9 : label is "soft_lutpair32";
  attribute SOFT_HLUTNM of parity_bit_i_2 : label is "soft_lutpair29";
begin
  SR(0) <= \^sr\(0);
...
\brgen_counter[4]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"40"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  ...
  attribute SOFT_HLUTNM of \control[31]_i_2\ : label is "soft_lutpair36";
  attribute SOFT_HLUTNM of \raddr[3]_i_1\ : label is "soft_lutpair37";
  attribute SOFT_HLUTNM of \status[7]_i_2\ : label is "soft_lutpair36";
begin
