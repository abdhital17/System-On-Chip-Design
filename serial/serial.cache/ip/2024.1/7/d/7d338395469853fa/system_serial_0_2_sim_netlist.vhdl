...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_brd is
  ...
  attribute SOFT_HLUTNM of \brgen_counter[4]_i_4\ : label is "soft_lutpair0";
...
\brgen_counter[4]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"DF"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of bit_a_i_2 : label is "soft_lutpair24";
  ...
  attribute SOFT_HLUTNM of \brgen_counter[3]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \brgen_counter[4]_i_2\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \brgen_counter[4]_i_3\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \latched_data[0]_i_2\ : label is "soft_lutpair22";
  ...
  attribute SOFT_HLUTNM of \latched_data[4]_i_3\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \latched_data[6]_i_2\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \latched_data[6]_i_3\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \latched_data[7]_i_1\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \latched_data[7]_i_2\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \ones[0]_i_2__0\ : label is "soft_lutpair19";
  ...
  attribute SOFT_HLUTNM of \state[3]_i_4\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \state[3]_i_5\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of wr_request_i_3 : label is "soft_lutpair17";
begin
...
\latched_data[0]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFDF"
    )
        port map (
...
\latched_data[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \latched_data[3]_i_3_n_0\,
      I3 => \state_reg_n_0_[2]\,
      I4 => \brgen_counter_reg_n_0_[4]\,
      I5 => \^data\(3),
      O => \latched_data[3]_i_1_n_0\
    );
\latched_data[3]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\latched_data[4]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FE"
    )
        port map (
...
\latched_data[7]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000020"
    )
        port map (
...
wr_request_i_3: unisim.vcomponents.LUT5
    generic map(
      INIT => X"BFFFBFFE"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter is
  ...
  attribute SOFT_HLUTNM of baud_en : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \brgen_counter[0]_i_1__0\ : label is "soft_lutpair31";
  ...
  attribute SOFT_HLUTNM of \brgen_counter[4]_i_2\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \ones[0]_i_4\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of \ones[0]_i_5\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of out_data_i_5 : label is "soft_lutpair26";
...
receiver_1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver
     port map (
      ...
      \latched_data_reg[6]_0\ => transmitter_1_n_4,
      ok_to_write_rx => ok_to_write_rx,
      parity_error => parity_error,
