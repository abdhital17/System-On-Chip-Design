...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter is
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_state[2]_i_1\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of rd_request_i_2 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of rd_request_i_3 : label is "soft_lutpair8";
begin
...
transmitter_1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter
     port map (
      E(0) => brgen_counter0,
      \FSM_sequential_state_reg[0]_0\ => \^rd_index_reg[3]\,
      \FSM_sequential_state_reg[3]_0\ => transmitter_1_n_4,
      SR(0) => fifo1_n_19,
      axi_aclk => axi_aclk,
      axi_aresetn => axi_aresetn,
      brd_out => brd_out,
