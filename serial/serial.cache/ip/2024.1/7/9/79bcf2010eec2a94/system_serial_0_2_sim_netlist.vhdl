...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_brd is
  ...
  attribute SOFT_HLUTNM of \test_reg[1]_i_4\ : label is "soft_lutpair0";
begin
  brd_out <= \^brd_out\;
...
\test_reg[1]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"DF"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  port (
    \test_reg_reg[1]_0\ : out STD_LOGIC_VECTOR ( 0 to 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  ...
  signal bit_a_reg_i_1_n_0 : STD_LOGIC;
  ...
  signal bit_in_reg_i_1_n_0 : STD_LOGIC;
  ...
  signal \test_reg[1]_i_3_n_0\ : STD_LOGIC;
  signal \^test_reg_reg[1]_0\ : STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  attribute SOFT_HLUTNM of \brgen_counter[3]_i_4\ : label is "soft_lutpair25";
  ...
  attribute SOFT_HLUTNM of \latched_data[1]_i_3\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \latched_data[2]_i_2\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \latched_data[3]_i_2\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \latched_data[5]_i_2\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \latched_data[7]_i_2\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \latched_data[7]_i_3\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \ones[0]_i_2\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of parity_bit_i_2 : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of parity_error_i_4 : label is "soft_lutpair16";
  ...
  attribute SOFT_HLUTNM of \test_reg[1]_i_3\ : label is "soft_lutpair19";
...
begin
  ...
  \test_reg_reg[1]_0\(0) <= \^test_reg_reg[1]_0\(0);
\FSM_sequential_state[0]_i_2__0\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0800FEFF0000FFFF"
    )
        port map (
...
\brgen_counter[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I3 => \state__0\(2),
      I4 => \state__0\(3),
      I5 => \brgen_counter[3]_i_4_n_0\,
      O => \brgen_counter[3]_i_1_n_0\
    );
\brgen_counter[3]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\brgen_counter[3]_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
frame_error_i_2: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0004400000044005"
    )
        port map (
      I0 => \latched_data_reg[3]_0\,
...
\latched_data[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFF7FF00000400"
        ...
        port map (
      I0 => \latched_data[1]_i_2_n_0\,
      I1 => bit_in_reg_i_1_n_0,
      I2 => \state__0\(3),
      I3 => axi_aresetn,
...
\latched_data[1]_i_3\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"BF"
    )
        port map (
...
\latched_data[7]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"BA"
    )
        port map (
...
\ones[0]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"A9"
    )
        port map (
...
\test_reg[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \state__0\(1),
      I3 => \test_reg[1]_i_3_n_0\,
      I4 => \latched_data_reg[3]_0\,
      I5 => \^test_reg_reg[1]_0\(0),
...
\test_reg[1]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  port (
    ...
    clk_out : out STD_LOGIC;
    tx_out : out STD_LOGIC;
    \test_reg_reg[1]\ : out STD_LOGIC_VECTOR ( 0 to 0 );
...
receiver_1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver
     port map (
      ...
      \FSM_sequential_state_reg[2]_0\ => transmitter_1_n_6,
      Q(4) => in6,
      ...
      in_prev_reg_0 => transmitter_1_n_5,
      ...
      \test_reg_reg[1]_0\(0) => \test_reg_reg[1]\(0),
...
serial_v1_0_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI
     port map (
      ...
      rx_in => rx_in,
      \test_reg_reg[1]\(0) => \test_reg_reg[1]\(0),
      tx_out => tx_out,
      watermark(4 downto 0) => watermark(4 downto 0),
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal \^rd_data\ : STD_LOGIC_VECTOR ( 1 to 1 );
