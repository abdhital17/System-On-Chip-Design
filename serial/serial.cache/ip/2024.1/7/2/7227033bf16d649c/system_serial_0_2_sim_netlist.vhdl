...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  ...
  attribute SOFT_HLUTNM of \brgen_counter[3]_i_2\ : label is "soft_lutpair19";
  ...
  attribute SOFT_HLUTNM of \state[3]_i_6\ : label is "soft_lutpair18";
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_state[0]_i_5\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \FSM_sequential_state[0]_i_7\ : label is "soft_lutpair22";
  ...
  attribute SOFT_HLUTNM of baud_en : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \brgen_counter[0]_i_1__0\ : label is "soft_lutpair27";
  ...
  attribute SOFT_HLUTNM of \ones[0]_i_4\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \ones[0]_i_5\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of out_data_i_5 : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of parity_bit_i_3 : label is "soft_lutpair24";
begin
  SR(0) <= \^sr\(0);
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  port (
    \control_reg[3]_0\ : out STD_LOGIC_VECTOR ( 7 downto 0 );
    ...
    clk_out : out STD_LOGIC;
    parity_bit_reg : out STD_LOGIC_VECTOR ( 0 to 0 );
    tx_out : out STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  ...
  signal \^control_reg[3]_0\ : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  signal receiver_1_n_8 : STD_LOGIC;
  signal receiver_1_n_9 : STD_LOGIC;
...
begin
  ...
  \control_reg[3]_0\(7 downto 0) <= \^control_reg[3]_0\(7 downto 0);
  empty <= \^empty\;
...
\control_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => axi_aclk,
      CE => \control[3]_i_1_n_0\,
      D => axi_wdata(0),
      Q => \^control_reg[3]_0\(4),
      R => transmitter_1_n_1
    );
...
fifo_rx: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9
     port map (
      ...
      \axi_rdata_reg[12]_0\(2 downto 0) => \^control_reg[3]_0\(6 downto 4),
      empty => \^empty\,
      fe_out => fe_out,
      ok_to_write_rx_edge => ok_to_write_rx_edge,
...
fifo_tx: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9_0
     port map (
      ...
      \axi_rdata_reg[20]\(0) => \^control_reg[3]_0\(7),
...
receiver_1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver
     port map (
      Q(3 downto 0) => \^control_reg[3]_0\(3 downto 0),
      SR(0) => transmitter_1_n_1,
      axi_aclk => axi_aclk,
      axi_aresetn => axi_aresetn,
      ...
      ok_to_write_rx => ok_to_write_rx,
      parity_bit_reg_0(0) => parity_bit_reg(0),
      parity_error => parity_error,
      ...
      rx_in => rx_in,
      \state_reg[2]_0\ => transmitter_1_n_4,
      \state_reg[3]_0\(4) => data50,
      \state_reg[3]_0\(3 downto 0) => \^control_reg[3]_0\(7 downto 4),
      \status_reg[6]\ => receiver_1_n_8,
      \status_reg[7]\ => receiver_1_n_9,
      wr_request_reg_0 => receiver_1_n_10
    );
...
transmitter_1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter
     port map (
      ...
      Q(4) => data50,
      Q(3 downto 0) => \^control_reg[3]_0\(7 downto 4),
      SR(0) => transmitter_1_n_1,
      axi_aclk => axi_aclk,
      axi_aresetn => axi_aresetn,
      brd_out => brd_out,
      brgen_prev => brgen_prev,
      \control_reg[1]\ => transmitter_1_n_4,
      ok_to_read_tx => ok_to_read_tx,
      previous_state => previous_state,
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial is
  port (
    Q : out STD_LOGIC_VECTOR ( 3 downto 0 );
    \control_reg[3]\ : out STD_LOGIC_VECTOR ( 3 downto 0 );
    \watermark_reg[4]\ : out STD_LOGIC_VECTOR ( 4 downto 0 );
    S_AXI_WREADY : out STD_LOGIC;
    S_AXI_AWREADY : out STD_LOGIC;
    S_AXI_ARREADY : out STD_LOGIC;
...
serial_v1_0_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI
     port map (
      ...
      axi_wvalid => axi_wvalid,
      clk_out => clk_out,
      \control_reg[3]_0\(7 downto 4) => \control_reg[3]\(3 downto 0),
      \control_reg[3]_0\(3 downto 0) => Q(3 downto 0),
      empty => empty,
      overflow_reg => overflow_reg,
      parity_bit_reg(0) => parity_bit_reg(0),
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial
     port map (
      Q(3 downto 0) => rd_data(4 downto 1),
      ...
      axi_wvalid => axi_wvalid,
      clk_out => clk_out,
      \control_reg[3]\(3 downto 0) => rd_data(8 downto 5),
      empty => empty,
      overflow_reg => overflow,
      parity_bit_reg(0) => rd_data(0),
