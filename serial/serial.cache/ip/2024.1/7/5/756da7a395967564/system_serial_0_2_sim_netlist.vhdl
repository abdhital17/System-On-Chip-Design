...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9 is
  ...
  attribute SOFT_HLUTNM of \watermark[1]_i_1__0\ : label is "soft_lutpair5";
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9_0 is
  ...
  signal \wr_index[4]_i_1__0_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \watermark[1]_i_1\ : label is "soft_lutpair11";
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  port (
    ...
    \test_reg[3]_0\ : out STD_LOGIC_VECTOR ( 3 downto 0 );
    axi_aclk : in STD_LOGIC;
    rx_in : in STD_LOGIC;
    axi_aresetn : in STD_LOGIC;
    ...
    p_0_in_0 : in STD_LOGIC_VECTOR ( 1 downto 0 );
    \state_reg[3]_i_6_0\ : in STD_LOGIC_VECTOR ( 5 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  ...
  signal \test[0]_i_1_n_0\ : STD_LOGIC;
  signal \test[1]_i_1_n_0\ : STD_LOGIC;
  signal \test[1]_i_2_n_0\ : STD_LOGIC;
  signal \test[1]_i_3_n_0\ : STD_LOGIC;
  signal \test[1]_i_4_n_0\ : STD_LOGIC;
  signal \test[2]_i_1_n_0\ : STD_LOGIC;
  signal \test[3]_i_1_n_0\ : STD_LOGIC;
  signal \^test_reg[3]_0\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal wr_request_i_1_n_0 : STD_LOGIC;
  signal wr_request_i_2_n_0 : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of bit_c_i_2 : label is "soft_lutpair20";
  ...
  attribute SOFT_HLUTNM of fe_i_2 : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of in_prev_i_2 : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \state[0]_i_7\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \state[3]_i_3\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \state[3]_i_4\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \state[3]_i_5\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \test[1]_i_4\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of wr_request_i_2 : label is "soft_lutpair17";
begin
  ok_to_write_rx <= \^ok_to_write_rx\;
  \test_reg[3]_0\(3 downto 0) <= \^test_reg[3]_0\(3 downto 0);
...
fe_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"F704"
    )
        port map (
...
fe_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFE7FFFF"
    )
        port map (
...
\test[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\test[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\test[1]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\test[1]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
\test[1]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
...
\test[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\test[3]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\test[3]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
wr_request_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter is
  ...
  attribute SOFT_HLUTNM of baud_en : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \brgen_counter[0]_i_1__0\ : label is "soft_lutpair21";
  ...
  attribute SOFT_HLUTNM of \pulse_i_1__1\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of rd_request_i_1 : label is "soft_lutpair25";
begin
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  port (
    ...
    \test_reg[3]\ : out STD_LOGIC_VECTOR ( 3 downto 0 );
...
receiver_1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver
     port map (
      ...
      axi_aclk => axi_aclk,
      axi_aresetn => axi_aresetn,
      \axi_rdata_reg[6]\(0) => \rd_data__0\(6),
      brd_out => brd_out,
      brgen_counter0 => brgen_counter0,
      brgen_prev => brgen_prev,
      ok_to_write_rx => ok_to_write_rx,
      ...
      \state_reg[3]_i_6_0\(5) => data50,
      \state_reg[3]_i_6_0\(4) => \control_reg_n_0_[6]\,
      \state_reg[3]_i_6_0\(3) => \control_reg_n_0_[3]\,
      \state_reg[3]_i_6_0\(2) => \control_reg_n_0_[2]\,
      \state_reg[3]_i_6_0\(1) => \control_reg_n_0_[1]\,
      \state_reg[3]_i_6_0\(0) => \control_reg_n_0_[0]\,
      \test_reg[3]_0\(3 downto 0) => \test_reg[3]\(3 downto 0),
...
serial_v1_0_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI
     port map (
      ...
      rx_in => rx_in,
      \test_reg[3]\(3 downto 0) => \test_reg[3]\(3 downto 0),
      tx_out => tx_out,
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial
     port map (
      ...
      rx_in => rx_in,
      \test_reg[3]\(3 downto 0) => \^rd_data\(3 downto 0),
      tx_out => tx_out,
