...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_brd is
  ...
  attribute SOFT_HLUTNM of \parity_bit_i_2__0\ : label is "soft_lutpair0";
begin
  brd_out <= \^brd_out\;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  ...
  signal parity_bit_i_4_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of parity_bit_i_3 : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of parity_bit_i_4 : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \state[0]_i_3\ : label is "soft_lutpair19";
...
parity_bit_i_4: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter is
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_state[0]_i_7\ : label is "soft_lutpair23";
  ...
  attribute SOFT_HLUTNM of \ones[0]_i_4\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \ones[0]_i_5\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of out_data_i_5 : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \parity_bit_i_3__0\ : label is "soft_lutpair25";
begin
  SR(0) <= \^sr\(0);
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  port (
    parity_bit_reg : out STD_LOGIC_VECTOR ( 1 downto 0 );
...
receiver_1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver
     port map (
      ...
      ok_to_write_rx => ok_to_write_rx,
      parity_bit_reg_0(0) => parity_bit_reg(1),
      parity_error => parity_error,
      ...
      \state_reg[2]_0\ => transmitter_1_n_7,
      \state_reg[3]_0\ => transmitter_1_n_6,
...
transmitter_1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter
     port map (
      ...
      \control_reg[1]\ => transmitter_1_n_7,
...
serial_v1_0_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI
     port map (
      ...
      parity_bit_reg(1 downto 0) => parity_bit_reg(1 downto 0),
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial
     port map (
      ...
      parity_bit_reg(1 downto 0) => \^rd_data\(1 downto 0),
