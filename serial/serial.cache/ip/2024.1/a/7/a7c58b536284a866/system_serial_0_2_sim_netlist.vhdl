...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detector is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \axi_rdata[31]_i_1\ : label is "soft_lutpair11";
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9_0 is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_state[0]_i_7\ : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \rd_index[1]_i_1\ : label is "soft_lutpair10";
  ...
  attribute SOFT_HLUTNM of \watermark[1]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \watermark[3]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \watermark[4]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \wr_index[1]_i_1\ : label is "soft_lutpair9";
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  port (
    \test_reg[1]_0\ : out STD_LOGIC_VECTOR ( 1 downto 0 );
    axi_aclk : in STD_LOGIC
  );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  ...
  signal \^test_reg[1]_0\ : STD_LOGIC_VECTOR ( 1 downto 0 );
begin
  \test_reg[1]_0\(1 downto 0) <= \^test_reg[1]_0\(1 downto 0);
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter is
  ...
  attribute SOFT_HLUTNM of baud_en : label is "soft_lutpair14";
  ...
  attribute SOFT_HLUTNM of \brgen_counter[4]_i_2\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of out_data_i_6 : label is "soft_lutpair13";
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  port (
    ...
    \test_reg[1]\ : out STD_LOGIC_VECTOR ( 1 downto 0 );
    watermark : out STD_LOGIC_VECTOR ( 4 downto 0 );
...
fifo_tx: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9_0
     port map (
      ...
      p_0_in_0(1 downto 0) => p_0_in_0(1 downto 0),
      \rd_index_reg[0]_0\ => fifo_tx_n_18,
      \rd_index_reg[0]_1\ => fifo_tx_n_21,
      \rd_index_reg[3]_0\ => fifo_tx_n_20,
      status(0) => status(5),
      \wr_index_reg[4]_0\ => fifo_tx_n_19,
      write_en => write_en
    );
...
read_request_detector_rx: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detector
     port map (
      ...
      empty => \^empty\,
      pulse_reg_0 => read_request_detector_rx_n_1,
      pulse_reg_1 => \^axi_rvalid_reg_0\,
      pulse_reg_2 => \^s_axi_arready\,
      read_en => read_en,
      status(0) => status(2)
    );
...
receiver_1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver
     port map (
      axi_aclk => axi_aclk,
      \test_reg[1]_0\(1 downto 0) => \test_reg[1]\(1 downto 0)
    );
...
transmitter_1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter
     port map (
      ...
      \FSM_sequential_state_reg[0]_2\ => fifo_tx_n_20,
...
serial_v1_0_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI
     port map (
      ...
      \test_reg[1]\(1 downto 0) => \test_reg[1]\(1 downto 0),
      tx_out => tx_out,
      watermark(4 downto 0) => watermark(4 downto 0)
    );
end STRUCTURE;
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial
     port map (
      ...
      \test_reg[1]\(1 downto 0) => \^rd_data\(1 downto 0),
      tx_out => tx_out,
      watermark(4 downto 0) => watermark(4 downto 0)
    );
end STRUCTURE;
