...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detector_0 is
  ...
  signal \^wr\ : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of previous_state_i_1 : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of pulse_i_1 : label is "soft_lutpair14";
begin
  wr <= \^wr\;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9 is
  ...
  attribute SOFT_HLUTNM of empty_INST_0_i_1 : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \watermark[1]_i_1\ : label is "soft_lutpair1";
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter is
  port (
    ...
    \test_reg[6]_0\ : out STD_LOGIC_VECTOR ( 6 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter is
  ...
  signal \^test_reg[6]_0\ : STD_LOGIC_VECTOR ( 6 downto 0 );
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of baud_en_i_1 : label is "soft_lutpair12";
  attribute ADDER_THRESHOLD : integer;
  ...
  attribute SOFT_HLUTNM of \brgen_counter[0]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \brgen_counter[1]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \brgen_counter[4]_i_4\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of rd_request_i_2 : label is "soft_lutpair13";
  ...
  attribute SOFT_HLUTNM of \state[3]_i_3\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \state[3]_i_7\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \test[6]_i_2\ : label is "soft_lutpair9";
begin
  ok_to_read <= \^ok_to_read\;
  \test_reg[6]_0\(6 downto 0) <= \^test_reg[6]_0\(6 downto 0);
  tx_out <= \^tx_out\;
...
out_data_i_13: unisim.vcomponents.LUT5
    generic map(
      INIT => X"9A5A9555"
    )
        port map (
...
out_data_i_14: unisim.vcomponents.LUT5
    generic map(
      INIT => X"3060C060"
    )
        port map (
...
rd_request_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FEFF"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  port (
    ...
    \wr_index_reg[4]_0\ : out STD_LOGIC;
    overflow : out STD_LOGIC;
    \test_reg[6]\ : out STD_LOGIC_VECTOR ( 6 downto 0 );
...
fifo1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9
     port map (
      ...
      \brd_reg[20]\(13) => fifo1_n_21,
      \brd_reg[20]\(12) => fifo1_n_22,
      \brd_reg[20]\(11) => fifo1_n_23,
      \brd_reg[20]\(10) => fifo1_n_24,
      \brd_reg[20]\(9) => fifo1_n_25,
      \brd_reg[20]\(8) => fifo1_n_26,
      \brd_reg[20]\(7) => fifo1_n_27,
      \brd_reg[20]\(6) => fifo1_n_28,
      \brd_reg[20]\(5) => fifo1_n_29,
      \brd_reg[20]\(4) => fifo1_n_30,
      \brd_reg[20]\(3) => fifo1_n_31,
      \brd_reg[20]\(2) => fifo1_n_32,
      \brd_reg[20]\(1) => fifo1_n_33,
      \brd_reg[20]\(0) => fifo1_n_34,
...
transmitter_1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter
     port map (
      ...
      \test_reg[6]_0\(6 downto 0) => \test_reg[6]\(6 downto 0),
      tx_out => tx_out
    );
...
serial_v1_0_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI
     port map (
      ...
      overflow => overflow,
      rd_index(0) => rd_index(0),
      \test_reg[6]\(6 downto 0) => \test_reg[6]\(6 downto 0),
      tx_out => tx_out,
      watermark(4 downto 0) => watermark(4 downto 0),
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial
     port map (
      ...
      \test_reg[6]\(6 downto 0) => \^rd_data\(6 downto 0),
      tx_out => tx_out,
      watermark(4 downto 0) => watermark(4 downto 0),
      wr_index(4 downto 0) => wr_index(4 downto 0),
      \wr_index_reg[4]\ => full,
