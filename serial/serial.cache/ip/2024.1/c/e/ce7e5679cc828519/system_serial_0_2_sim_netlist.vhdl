...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_brd is
  ...
  attribute SOFT_HLUTNM of bit_a_i_3 : label is "soft_lutpair0";
...
bit_a_i_3: unisim.vcomponents.LUT3
    generic map(
      INIT => X"DF"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9 is
  ...
  attribute SOFT_HLUTNM of \wr_index[4]_i_3__0\ : label is "soft_lutpair4";
begin
...
\wr_index[4]_i_3__0\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"6AAAAAAA"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9_0 is
  ...
  attribute SOFT_HLUTNM of \rd_index[3]_i_2\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \rd_index[4]_i_1__0\ : label is "soft_lutpair10";
...
\rd_index[3]_i_3\: unisim.vcomponents.LUT6
    generic map(
...
\rd_index[3]_i_5\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6FF6"
    )
        port map (
...
\wr_index[4]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"2002000000002002"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  ...
  signal \^control_reg[1]\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \brgen_counter[3]_i_4\ : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of parity_bit_i_2 : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of parity_error_i_4 : label is "soft_lutpair19";
  ...
  attribute SOFT_HLUTNM of \state[3]_i_4\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \state[3]_i_5\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of wr_request_i_2 : label is "soft_lutpair16";
begin
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter is
  ...
  attribute SOFT_HLUTNM of \brgen_counter[3]_i_1\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \brgen_counter[4]_i_2\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \ones[0]_i_2__0\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \ones[0]_i_4\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of out_data_i_4 : label is "soft_lutpair24";
  ...
  attribute SOFT_HLUTNM of out_data_i_7 : label is "soft_lutpair24";
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  port (
    ...
    \rd_index_reg[3]\ : out STD_LOGIC_VECTOR ( 3 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  ...
  signal fifo_tx_n_23 : STD_LOGIC;
  signal fifo_tx_n_24 : STD_LOGIC;
  signal fifo_tx_n_25 : STD_LOGIC;
  signal fifo_tx_n_26 : STD_LOGIC;
  signal fifo_tx_n_27 : STD_LOGIC;
  signal fifo_tx_n_28 : STD_LOGIC;
  signal fifo_tx_n_29 : STD_LOGIC;
  signal frame_error : STD_LOGIC;
...
fifo_rx: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9
     port map (
      ...
      pe_out => pe_out,
      \rd_index_reg[0]_0\ => \rd_index_reg[3]\(0),
      \rd_index_reg[1]_0\ => \rd_index_reg[3]\(1),
      \rd_index_reg[1]_1\ => \rd_index_reg[1]\,
      \rd_index_reg[2]_0\ => \rd_index_reg[3]\(2),
      \rd_index_reg[3]_0\ => \rd_index_reg[3]\(3),
...
fifo_tx: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9_0
     port map (
      ...
      \brd_reg[20]\(7) => fifo_tx_n_18,
      \brd_reg[20]\(6) => fifo_tx_n_19,
      \brd_reg[20]\(5) => fifo_tx_n_20,
      \brd_reg[20]\(4) => fifo_tx_n_21,
      \brd_reg[20]\(3) => fifo_tx_n_22,
      \brd_reg[20]\(2) => fifo_tx_n_23,
      \brd_reg[20]\(1) => fifo_tx_n_24,
      \brd_reg[20]\(0) => fifo_tx_n_25,
      ok_to_read_tx_edge => ok_to_read_tx_edge,
      ok_to_write_tx => ok_to_write_tx,
      p_0_in_0(1 downto 0) => p_0_in_0(1 downto 0),
      \rd_index_reg[0]_0\ => ADDRA(0),
      \rd_index_reg[0]_1\ => fifo_tx_n_26,
      \rd_index_reg[0]_2\ => fifo_tx_n_29,
      \rd_index_reg[1]_0\ => ADDRA(1),
      \rd_index_reg[2]_0\ => ADDRA(2),
      \rd_index_reg[3]_0\ => ADDRA(3),
      \rd_index_reg[3]_1\ => fifo_tx_n_28,
      status(0) => status(5),
      wr_data(8) => \wr_data_reg_n_0_[8]\,
      wr_data(7) => \wr_data_reg_n_0_[7]\,
      wr_data(6) => \wr_data_reg_n_0_[6]\,
      ...
      wr_data(1) => \wr_data_reg_n_0_[1]\,
      wr_data(0) => \wr_data_reg_n_0_[0]\,
      \wr_index_reg[4]_0\ => fifo_tx_n_27,
      write_en => write_en
    );
...
transmitter_1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter
     port map (
      D(8 downto 0) => rd_data(8 downto 0),
      E(0) => brgen_counter0,
      \FSM_sequential_state_reg[0]_0\ => fifo_tx_n_26,
      \FSM_sequential_state_reg[0]_1\ => fifo_tx_n_27,
      \FSM_sequential_state_reg[0]_2\ => fifo_tx_n_28,
      \FSM_sequential_state_reg[0]_3\ => fifo_tx_n_29,
      \FSM_sequential_state_reg[0]_4\ => receiver_1_n_3,
      Q(4) => data50,
      Q(3) => \control_reg_n_0_[3]\,
      Q(2) => \control_reg_n_0_[2]\,
      Q(1) => \control_reg_n_0_[1]\,
...
serial_v1_0_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI
     port map (
      ...
      \rd_index_reg[1]\ => \rd_index_reg[1]_1\,
      \rd_index_reg[3]\(3) => \rd_index_reg[3]_0\,
      \rd_index_reg[3]\(2) => \rd_index_reg[2]_0\,
      \rd_index_reg[3]\(1) => \rd_index_reg[1]_0\,
      \rd_index_reg[3]\(0) => \rd_index_reg[0]_0\,
      rx_in => rx_in,
      tx_out => tx_out,
      \watermark_reg[4]\(4 downto 0) => \watermark_reg[4]\(4 downto 0),
      wr_index(4 downto 0) => wr_index(4 downto 0),
      \wr_index_reg[4]\(4 downto 0) => \wr_index_reg[4]\(4 downto 0)
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial
     port map (
      ...
      \rd_index_reg[0]\ => rd_data(5),
      \rd_index_reg[0]_0\ => rd_index(0),
      \rd_index_reg[1]\ => rd_data(6),
      \rd_index_reg[1]_0\ => rd_index(1),
      \rd_index_reg[1]_1\ => full,
      \rd_index_reg[2]\ => rd_data(7),
      \rd_index_reg[2]_0\ => rd_index(2),
      \rd_index_reg[3]\ => rd_data(8),
      \rd_index_reg[3]_0\ => rd_index(3),
      rx_in => rx_in,
      tx_out => tx_out,
      \watermark_reg[4]\(4 downto 0) => watermark(4 downto 0),
      wr_index(4 downto 0) => wr_index(4 downto 0),
      \wr_index_reg[4]\(4 downto 0) => rd_data(4 downto 0)
    );
end STRUCTURE;
