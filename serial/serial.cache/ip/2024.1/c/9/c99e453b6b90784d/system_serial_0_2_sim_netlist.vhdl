...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_state[0]_i_2__0\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \FSM_sequential_state[0]_i_4__0\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \FSM_sequential_state[0]_i_6__0\ : label is "soft_lutpair21";
  ...
  attribute SOFT_HLUTNM of \brgen_counter[1]_i_1\ : label is "soft_lutpair18";
  ...
  attribute SOFT_HLUTNM of \latched_data[0]_i_2\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \latched_data[1]_i_2\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \latched_data[1]_i_3\ : label is "soft_lutpair21";
  ...
  attribute SOFT_HLUTNM of wr_request_i_1 : label is "soft_lutpair14";
begin
...
\FSM_sequential_state[3]_i_1__0\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"10001055"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_state[0]_i_3__0\ : label is "soft_lutpair23";
  ...
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[2]\ : label is "D2:0100,D1:0011,D0:0010,STOP2:1100,STOP1:1011,P:1010,START:0001,IDLE:0000,D5:0111,D7:1001,D4:0110,D6:1000,D3:0101";
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[3]\ : label is "D2:0100,D1:0011,D0:0010,STOP2:1100,STOP1:1011,P:1010,START:0001,IDLE:0000,D5:0111,D7:1001,D4:0110,D6:1000,D3:0101";
  attribute SOFT_HLUTNM of baud_en : label is "soft_lutpair24";
  ...
  attribute SOFT_HLUTNM of \brgen_counter[4]_i_2\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \ones[0]_i_3__0\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \ones[0]_i_4\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \ones[0]_i_5\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of out_data_i_5 : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of parity_bit_i_2 : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of parity_bit_i_3 : label is "soft_lutpair25";
begin
  SR(0) <= \^sr\(0);
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  port (
    ...
    empty : out STD_LOGIC;
    overflow : out STD_LOGIC;
    fe_out_reg_0 : out STD_LOGIC_VECTOR ( 2 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  ...
  signal data : STD_LOGIC_VECTOR ( 7 downto 0 );
  signal \^empty\ : STD_LOGIC;
  signal \^fe_out_reg_0\ : STD_LOGIC_VECTOR ( 2 downto 0 );
...
begin
  ...
  empty <= \^empty\;
  fe_out_reg_0(2 downto 0) <= \^fe_out_reg_0\(2 downto 0);
...
fifo_rx: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9
     port map (
      ...
      \axi_rdata_reg[6]\(1 downto 0) => \^fe_out_reg_0\(2 downto 1),
      data(7 downto 0) => data(7 downto 0),
      empty => \^empty\,
...
receiver_1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver
     port map (
      ...
      \FSM_sequential_state_reg[3]_0\ => transmitter_1_n_7,
      Q(4) => in6,
      ...
      fe_out_reg_0(1 downto 0) => \^fe_out_reg_0\(2 downto 1),
      frame_error => frame_error,
      frame_error_prev => frame_error_prev,
      ok_to_write_rx => ok_to_write_rx,
      \ones_reg[0]_0\ => transmitter_1_n_6,
      parity_error => parity_error,
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial is
  port (
    ...
    empty : out STD_LOGIC;
    overflow : out STD_LOGIC;
    fe_out_reg : out STD_LOGIC_VECTOR ( 2 downto 0 );
    rd_index : out STD_LOGIC_VECTOR ( 0 to 0 );
...
serial_v1_0_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI
     port map (
      ...
      clk_out => clk_out,
      empty => empty,
      fe_out_reg_0(2 downto 0) => fe_out_reg(2 downto 0),
      overflow => overflow,
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial
     port map (
      ...
      clk_out => clk_out,
      empty => empty,
      fe_out_reg(2) => \^rd_data\(8),
      fe_out_reg(1) => \^rd_data\(2),
      fe_out_reg(0) => \^rd_data\(0),
      overflow => overflow,
