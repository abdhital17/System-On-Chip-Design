...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter is
  ...
  signal brgen_counter1 : STD_LOGIC_VECTOR ( 4 downto 0 );
  ...
  signal \brgen_counter[2]_i_3_n_0\ : STD_LOGIC;
  ...
  signal \brgen_counter[4]_i_6_n_0\ : STD_LOGIC;
  signal \brgen_counter[4]_i_7_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_onehot_state[10]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \FSM_onehot_state[11]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \FSM_onehot_state[12]_i_2\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \brgen_counter[2]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \brgen_counter[3]_i_3\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \brgen_counter[4]_i_3\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \brgen_counter[4]_i_6\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \brgen_counter[4]_i_7\ : label is "soft_lutpair11";
...
\brgen_counter[0]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"6900"
    )
        port map (
      I0 => \brgen_counter0_carry__0_n_5\,
      I1 => brgen_counter(0),
      I2 => \brgen_counter[4]_i_4_n_0\,
      I3 => \brgen_counter[4]_i_6_n_0\,
      O => \brgen_counter[0]_i_1_n_0\
    );
\brgen_counter[1]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"2DD24BB400000000"
    )
        port map (
      I0 => \brgen_counter0_carry__0_n_5\,
      I1 => brgen_counter(0),
      ...
      I5 => \brgen_counter[4]_i_6_n_0\,
      O => \brgen_counter[1]_i_1_n_0\
    );
\brgen_counter[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"5995555500000000"
    )
        port map (
      I0 => \brgen_counter[2]_i_2_n_0\,
      I1 => \brgen_counter[4]_i_4_n_0\,
      I2 => brgen_counter(0),
      I3 => \brgen_counter0_carry__0_n_5\,
      I4 => \brgen_counter[2]_i_3_n_0\,
      I5 => \brgen_counter[4]_i_6_n_0\,
      O => \brgen_counter[2]_i_1_n_0\
    );
\brgen_counter[2]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"1E870FC3"
    )
        port map (
...
\brgen_counter[2]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"B44B"
    )
        port map (
...
\brgen_counter[3]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FBFEFD7F"
    )
        port map (
...
\brgen_counter[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"9669696900000000"
    )
        port map (
      I0 => \brgen_counter[4]_i_2_n_0\,
      I1 => brgen_counter1(4),
      I2 => \brgen_counter0_carry__0_n_5\,
      I3 => \brgen_counter[4]_i_4_n_0\,
      I4 => \brgen_counter[4]_i_5_n_0\,
      I5 => \brgen_counter[4]_i_6_n_0\,
...
\brgen_counter[4]_i_4\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"ECCB3EECCBB3ECCB"
        ...
        port map (
      I0 => \brgen_counter[4]_i_5_n_0\,
      I1 => \brgen_counter0_carry__0_n_4\,
      I2 => \brgen_counter[4]_i_7_n_0\,
      I3 => brgen_counter(4),
      I4 => \brgen_counter0_carry__0_n_5\,
      I5 => \brgen_counter[4]_i_2_n_0\,
...
\brgen_counter[4]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFD"
    )
        port map (
      ...
      I3 => brgen_counter(2),
      I4 => brgen_counter(3),
      O => \brgen_counter[4]_i_6_n_0\
    );
\brgen_counter[4]_i_7\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
\latched_data[7]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
\ones[31]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  ...
  signal transmitter_1_n_0 : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \control[31]_i_2\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \raddr[3]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \status[5]_i_1\ : label is "soft_lutpair15";
begin
