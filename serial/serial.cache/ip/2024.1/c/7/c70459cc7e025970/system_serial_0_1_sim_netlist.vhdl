...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9 is
  port (
    ...
    \axi_rdata_reg[20]\ : in STD_LOGIC_VECTOR ( 9 downto 0 );
    status : in STD_LOGIC_VECTOR ( 0 to 0 );
    axi_aresetn : in STD_LOGIC;
    write_en : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9 is
  ...
  attribute SOFT_HLUTNM of \wr_index[4]_i_2\ : label is "soft_lutpair4";
begin
  SR(0) <= \^sr\(0);
  overflow <= \^overflow\;
...
\control[1]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\control[1]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4000"
    )
        port map (
...
fifo1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9
     port map (
      ...
      Q(13 downto 9) => ibrd(12 downto 8),
      Q(8) => ibrd(0),
      Q(7) => \brd_reg_n_0_[7]\,
      Q(6) => \brd_reg_n_0_[6]\,
      Q(5) => \brd_reg_n_0_[5]\,
      ...
      \axi_rdata_reg[20]\(9) => \control_reg_n_0_[20]\,
      \axi_rdata_reg[20]\(8) => \control_reg_n_0_[19]\,
      \axi_rdata_reg[20]\(7) => \control_reg_n_0_[18]\,
      \axi_rdata_reg[20]\(6) => \control_reg_n_0_[17]\,
      \axi_rdata_reg[20]\(5) => \control_reg_n_0_[16]\,
      \axi_rdata_reg[20]\(4) => \control_reg_n_0_[8]\,
      \axi_rdata_reg[20]\(3) => \control_reg_n_0_[7]\,
      \axi_rdata_reg[20]\(2) => \control_reg_n_0_[6]\,
      \axi_rdata_reg[20]\(1) => p_0_in7_in,
      \axi_rdata_reg[20]\(0) => \control_reg_n_0_[4]\,
      ...
      status(0) => status(5),
      watermark(4 downto 0) => watermark(4 downto 0),
      wr_index(3 downto 0) => \^wr_index\(4 downto 1),
      write_en => write_en
    );
...
transmitter_1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter
     port map (
      E(0) => brgen_counter0,
      Q(4) => \^wr_index\(0),
      Q(3 downto 2) => \^wr_index\(2 downto 1),
      Q(1 downto 0) => \^wr_index\(4 downto 3),
      SR(0) => fifo1_n_9,
      axi_aclk => axi_aclk,
      axi_aresetn => axi_aresetn,
      brd_out => brd_out,
...
serial_v1_0_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI
     port map (
      ...
      tx_out => tx_out,
      watermark(4 downto 0) => watermark(4 downto 0),
      wr_index(4 downto 3) => Q(1 downto 0),
      wr_index(2 downto 1) => Q(3 downto 2),
      wr_index(0) => Q(4)
    );
end STRUCTURE;
library IEEE;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  signal \^wr_index\ : STD_LOGIC_VECTOR ( 4 downto 1 );
...
begin
  ...
  led(1) <= \<const0>\;
  led(0) <= \<const0>\;
  rd_index(4 downto 1) <= \^wr_index\(4 downto 1);
  rd_index(0) <= \^rd_index\(0);
  wr_index(4 downto 1) <= \^wr_index\(4 downto 1);
  wr_index(0) <= \^rd_index\(0);
