...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_brd is
  ...
  attribute SOFT_HLUTNM of \brgen_counter[3]_i_4\ : label is "soft_lutpair0";
...
\brgen_counter[3]_i_4\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"DF"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  port (
    ...
    \test_reg_reg[1]_0\ : out STD_LOGIC_VECTOR ( 1 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  ...
  signal bit_b_reg_n_0 : STD_LOGIC;
  ...
  signal latched_data : STD_LOGIC_VECTOR ( 7 to 7 );
  ...
  signal \^test_reg_reg[1]_0\ : STD_LOGIC_VECTOR ( 1 downto 0 );
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_state[0]_i_4__0\ : label is "soft_lutpair23";
  ...
  attribute SOFT_HLUTNM of bit_a_i_2 : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of bit_c_i_1 : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \brgen_counter[1]_i_1\ : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \brgen_counter[2]_i_1\ : label is "soft_lutpair24";
  ...
  attribute SOFT_HLUTNM of \latched_data[1]_i_2\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \latched_data[2]_i_2\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \latched_data[3]_i_2\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \latched_data[4]_i_2\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \latched_data[5]_i_2\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \latched_data[7]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \ones[0]_i_2__0\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \ones[0]_i_3__0\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of parity_error_i_4 : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of parity_error_i_5 : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \test_reg[1]_i_1\ : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \test_reg[1]_i_2\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of wr_request_i_1 : label is "soft_lutpair21";
...
begin
  ...
  \test_reg_reg[1]_0\(1 downto 0) <= \^test_reg_reg[1]_0\(1 downto 0);
...
\FSM_sequential_state[0]_i_4__0\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0004"
    )
        port map (
...
\FSM_sequential_state[0]_i_6__0\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"EEEF"
    )
        port map (
...
bit_a_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
bit_c_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFBF0080"
    )
        port map (
...
in_prev_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\latched_data[4]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
parity_error_i_3: unisim.vcomponents.LUT2
    generic map(
      INIT => X"6"
    )
        port map (
...
parity_error_i_5: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FEFEFFFE"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  port (
    ...
    \test_reg_reg[1]\ : out STD_LOGIC_VECTOR ( 1 downto 0 );
...
receiver_1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver
     port map (
      ...
      \test_reg_reg[1]_0\(1 downto 0) => \test_reg_reg[1]\(1 downto 0),
...
serial_v1_0_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI
     port map (
      ...
      rx_in => rx_in,
      \test_reg_reg[1]\(1 downto 0) => \test_reg_reg[1]\(1 downto 0),
      tx_out => tx_out,
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial
     port map (
      ...
      rx_in => rx_in,
      \test_reg_reg[1]\(1 downto 0) => \^rd_data\(1 downto 0),
      tx_out => tx_out,
