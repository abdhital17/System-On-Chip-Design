...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_brd is
  ...
  attribute SOFT_HLUTNM of \brgen_counter_reg[3]_i_2\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \test_reg[8]_i_3\ : label is "soft_lutpair0";
begin
  brd_out <= \^brd_out\;
...
\brgen_counter_reg[3]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detector_3 is
  ...
  signal \^wr\ : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of previous_state_i_1 : label is "soft_lutpair33";
  attribute SOFT_HLUTNM of pulse_i_1 : label is "soft_lutpair33";
begin
  wr <= \^wr\;
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  port (
    ...
    \test_reg_reg[8]_0\ : out STD_LOGIC_VECTOR ( 3 downto 0 );
    \test_reg_reg[2]_0\ : out STD_LOGIC_VECTOR ( 2 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  ...
  signal \brgen_counter__0\ : STD_LOGIC_VECTOR ( 2 downto 1 );
  signal \brgen_counter_reg[0]_i_1_n_0\ : STD_LOGIC;
  ...
  signal \latched_data[2]_i_3_n_0\ : STD_LOGIC;
  ...
  signal test_reg : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  signal \test_reg[8]_i_2_n_0\ : STD_LOGIC;
  signal \^test_reg_reg[2]_0\ : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal \^test_reg_reg[3]_i_1_0\ : STD_LOGIC;
  signal \test_reg_reg[3]_i_1_n_0\ : STD_LOGIC;
  signal \test_reg_reg[3]_i_3_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_state[0]_i_4__0\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \FSM_sequential_state[1]_i_4\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \FSM_sequential_state[3]_i_3\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \FSM_sequential_state[3]_i_3__0\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \FSM_sequential_state[3]_i_4\ : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of \brgen_counter_reg[0]_i_1\ : label is "soft_lutpair15";
  ...
  attribute SOFT_HLUTNM of \brgen_counter_reg[2]_i_1\ : label is "soft_lutpair16";
  ...
  attribute SOFT_HLUTNM of \brgen_counter_reg[3]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \latched_data[0]_i_2\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \latched_data[2]_i_2\ : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of \latched_data[2]_i_3\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \latched_data[3]_i_2\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \latched_data[5]_i_2\ : label is "soft_lutpair24";
  ...
  attribute SOFT_HLUTNM of parity_error_i_4 : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of \test_reg[0]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \test_reg[5]_i_1\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \test_reg[6]_i_1\ : label is "soft_lutpair25";
  attribute SOFT_HLUTNM of \test_reg[7]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \test_reg[8]_i_2\ : label is "soft_lutpair23";
  ...
  attribute SOFT_HLUTNM of \test_reg_reg[3]_i_3\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of wr_request_i_1 : label is "soft_lutpair19";
begin
  ...
  \test_reg_reg[2]_0\(2 downto 0) <= \^test_reg_reg[2]_0\(2 downto 0);
...
\FSM_sequential_state[3]_i_3__0\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"57FF"
    )
        port map (
...
\brgen_counter_reg[0]\: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
        ...
        port map (
      CLR => '0',
      D => \brgen_counter_reg[0]_i_1_n_0\,
      G => E(0),
      GE => '1',
      Q => brgen_counter(0)
    );
\brgen_counter_reg[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I3 => \state__0\(1),
      I4 => \state__0\(0),
      O => \brgen_counter_reg[0]_i_1_n_0\
    );
...
frame_error_i_2: unisim.vcomponents.LUT6
    generic map(
      INIT => X"00000000000CC005"
    )
        port map (
      I0 => \state__0\(3),
      I1 => frame_error_i_3_n_0,
      I2 => \state__0\(0),
      I3 => \state__0\(1),
      I4 => \state__0\(2),
      I5 => \test_reg_reg[2]_1\,
...
\latched_data[2]_i_1\: unisim.vcomponents.LUT6
    generic map(
      ...
      I0 => \^test_reg_reg[3]_i_1_0\,
      I1 => \state__0\(3),
      I2 => \latched_data[2]_i_2_n_0\,
      I3 => \state__0\(2),
      I4 => \latched_data[2]_i_3_n_0\,
      I5 => \^data\(2),
      O => \latched_data[2]_i_1_n_0\
    );
\latched_data[2]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\latched_data[2]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFF7FFF"
    )
        port map (
...
\latched_data[5]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"08"
    )
        port map (
...
\parity_bit_i_1__0\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"B8"
    )
        port map (
...
\test_reg[0]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"222AAAAA"
    )
        port map (
...
\test_reg[2]_i_1\: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => \test_reg_reg[2]_1\,
      I3 => \test_reg_reg[3]_i_3_n_0\,
      I4 => \^test_reg_reg[2]_0\(2),
      O => \test_reg[2]_i_1_n_0\
    );
\test_reg[5]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"2A"
    )
        port map (
...
\test_reg[6]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"2A"
    )
        port map (
...
\test_reg[7]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"02AA"
    )
        port map (
...
\test_reg[8]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"000057FF"
    )
        port map (
...
\test_reg[8]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"222A"
    )
        port map (
      ...
      I2 => \state__0\(0),
      I3 => \state__0\(1),
      O => \test_reg[8]_i_2_n_0\
    );
\test_reg_reg[0]\: unisim.vcomponents.FDRE
     port map (
      C => axi_aclk,
      CE => \test_reg[8]_i_1_n_0\,
      D => \test_reg[0]_i_1_n_0\,
      Q => \^test_reg_reg[2]_0\(0),
      R => '0'
    );
...
\test_reg_reg[3]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\test_reg_reg[8]\: unisim.vcomponents.FDRE
     port map (
      C => axi_aclk,
      CE => \test_reg[8]_i_1_n_0\,
      D => \test_reg[8]_i_2_n_0\,
      Q => \test_reg_reg[8]_0\(3),
      R => '0'
    );
...
wr_request_i_2: unisim.vcomponents.LUT6
    generic map(
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \FSM_sequential_state[0]_i_5\ : label is "soft_lutpair29";
  ...
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[2]\ : label is "D2:0100,D1:0011,D0:0010,STOP2:1100,STOP1:1011,P:1010,START:0001,IDLE:0000,D5:0111,D7:1001,D4:0110,D6:1000,D3:0101";
  attribute FSM_ENCODED_STATES of \FSM_sequential_state_reg[3]\ : label is "D2:0100,D1:0011,D0:0010,STOP2:1100,STOP1:1011,P:1010,START:0001,IDLE:0000,D5:0111,D7:1001,D4:0110,D6:1000,D3:0101";
  attribute SOFT_HLUTNM of baud_en : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \brgen_counter[0]_i_1\ : label is "soft_lutpair32";
  attribute SOFT_HLUTNM of \brgen_counter[1]_i_1\ : label is "soft_lutpair32";
  attribute SOFT_HLUTNM of \brgen_counter[2]_i_1\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of \brgen_counter[3]_i_1\ : label is "soft_lutpair30";
  attribute SOFT_HLUTNM of \brgen_counter[4]_i_1\ : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of \ones[0]_i_4\ : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of \ones[0]_i_5\ : label is "soft_lutpair31";
  attribute SOFT_HLUTNM of out_data_i_5 : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of parity_bit_i_3 : label is "soft_lutpair29";
begin
  SR(0) <= \^sr\(0);
...
\test_reg_reg[3]_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"B"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  port (
    ...
    \test_reg_reg[8]\ : out STD_LOGIC_VECTOR ( 4 downto 0 );
    \test_reg_reg[2]\ : out STD_LOGIC_VECTOR ( 2 downto 0 );
    watermark : out STD_LOGIC_VECTOR ( 4 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  ...
  attribute SOFT_HLUTNM of \raddr[3]_i_1\ : label is "soft_lutpair34";
begin
...
fifo_rx: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_fifo16x9
     port map (
      ...
      \rd_index_reg[4]_1\ => read_request_detector_rx_n_1,
      status(0) => status(2),
      watermark(4 downto 0) => watermark(4 downto 0)
    );
...
receiver_1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver
     port map (
      ...
      \FSM_sequential_state_reg[3]_0\ => transmitter_1_n_5,
      Q(4) => in6,
      ...
      \test_reg_reg[2]_0\(2 downto 0) => \test_reg_reg[2]\(2 downto 0),
      \test_reg_reg[2]_1\ => baudRateDivider_n_1,
      \test_reg_reg[3]_i_1_0\ => \test_reg_reg[8]\(0),
      \test_reg_reg[8]_0\(3 downto 0) => \test_reg_reg[8]\(4 downto 1),
...
transmitter_1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter
     port map (
      ...
      \FSM_sequential_state_reg[3]_0\ => receiver_1_n_4,
      Q(4) => in6,
      Q(3) => \control_reg_n_0_[3]\,
      Q(2) => \control_reg_n_0_[2]\,
      Q(1) => \control_reg_n_0_[1]\,
...
serial_v1_0_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI
     port map (
      ...
      rx_in => rx_in,
      \test_reg_reg[2]\(2 downto 0) => \test_reg_reg[2]\(2 downto 0),
      \test_reg_reg[8]\(4 downto 0) => \test_reg_reg[8]\(4 downto 0),
      tx_out => tx_out,
      watermark(4 downto 0) => watermark(4 downto 0),
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial
     port map (
      ...
      rx_in => rx_in,
      \test_reg_reg[2]\(2 downto 0) => \^rd_data\(2 downto 0),
      \test_reg_reg[8]\(4 downto 1) => \^rd_data\(8 downto 5),
      \test_reg_reg[8]\(0) => \^rd_data\(3),
      tx_out => tx_out,
      watermark(4 downto 0) => watermark(4 downto 0),
      wr_index(4 downto 0) => wr_index(4 downto 0)
    );
