...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_brd is
  port (
    ...
    rx_in : in STD_LOGIC;
    \test_reg_reg[0]\ : in STD_LOGIC_VECTOR ( 0 to 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_brd is
  ...
  signal \^baud_pulse_reg_0\ : STD_LOGIC;
...
begin
  baud_pulse_reg_0 <= \^baud_pulse_reg_0\;
  brd_out <= \^brd_out\;
...
\test_reg[0]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"E2"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_edge_detector_3 is
  ...
  signal \^wr\ : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of previous_state_i_1 : label is "soft_lutpair26";
  attribute SOFT_HLUTNM of pulse_i_1 : label is "soft_lutpair26";
begin
  wr <= \^wr\;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  ...
  attribute SOFT_HLUTNM of frame_error_i_1 : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of in_prev_i_2 : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of parity_error_i_1 : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of pe_out_i_1 : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \test_reg[1]_i_1\ : label is "soft_lutpair15";
begin
...
in_prev_i_2: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
parity_error_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"4"
    )
        port map (
      I0 => parity_error5_out,
      I1 => \^parity_error\,
...
\test_reg[6]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0800"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter is
  ...
  attribute SOFT_HLUTNM of baud_en : label is "soft_lutpair20";
  ...
  attribute SOFT_HLUTNM of \brgen_counter[4]_i_2\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \ones[0]_i_3\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of out_data_i_4 : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of out_data_i_5 : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of out_data_i_6 : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of out_data_i_7 : label is "soft_lutpair24";
  attribute SOFT_HLUTNM of parity_bit_i_3 : label is "soft_lutpair23";
begin
  SR(0) <= \^sr\(0);
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  ...
  signal baudRateDivider_n_2 : STD_LOGIC;
  ...
  signal \^test_reg_reg[6]\ : STD_LOGIC_VECTOR ( 3 downto 0 );
...
begin
  ...
  empty <= \^empty\;
  \test_reg_reg[6]\(3 downto 0) <= \^test_reg_reg[6]\(3 downto 0);
...
baudRateDivider: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_brd
     port map (
      ...
      rx_in => rx_in,
      rx_in_0 => baudRateDivider_n_2,
      \test_reg_reg[0]\(0) => \^test_reg_reg[6]\(0)
    );
...
receiver_1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver
     port map (
      ...
      rx_in => rx_in,
      \status_reg[6]\ => receiver_1_n_7,
      \status_reg[7]\ => receiver_1_n_8,
      \test_reg_reg[0]_0\ => baudRateDivider_n_2,
      \test_reg_reg[1]_0\ => baudRateDivider_n_1,
      \test_reg_reg[6]_0\(3 downto 0) => \^test_reg_reg[6]\(3 downto 0),
      wr_request_reg_0 => receiver_1_n_9
    );
