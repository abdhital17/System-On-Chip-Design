...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  port (
    ...
    \test_reg[8]_0\ : out STD_LOGIC_VECTOR ( 7 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver is
  ...
  signal test3_out : STD_LOGIC_VECTOR ( 0 to 0 );
  signal \test[1]_i_1_n_0\ : STD_LOGIC;
  signal \test[2]_i_1_n_0\ : STD_LOGIC;
  signal \test[2]_i_2_n_0\ : STD_LOGIC;
  signal \test[4]_i_1_n_0\ : STD_LOGIC;
  signal \test[5]_i_1_n_0\ : STD_LOGIC;
  signal \test[5]_i_2_n_0\ : STD_LOGIC;
  signal \test[5]_i_3_n_0\ : STD_LOGIC;
  signal \test[6]_i_1_n_0\ : STD_LOGIC;
  signal \test[7]_i_1_n_0\ : STD_LOGIC;
  signal \test[8]_i_1_n_0\ : STD_LOGIC;
  signal \test[8]_i_2_n_0\ : STD_LOGIC;
  signal \^test_reg[8]_0\ : STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  attribute SOFT_HLUTNM of \state[0]_i_7\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \state[0]_i_8\ : label is "soft_lutpair17";
  ...
  attribute SOFT_HLUTNM of \test[1]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \test[2]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \test[2]_i_2\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \test[5]_i_2\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \test[5]_i_3\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of wr_request_i_2 : label is "soft_lutpair19";
begin
  \control_reg[3]\ <= \^control_reg[3]\;
  ok_to_write_rx <= \^ok_to_write_rx\;
  \test_reg[8]_0\(7 downto 0) <= \^test_reg[8]_0\(7 downto 0);
...
\test[0]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\test[1]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"DF20"
    )
        port map (
...
\test[2]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"DF20"
    )
        port map (
...
\test[2]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
\test[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\test[5]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\test[5]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
\test[5]_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"7"
    )
        port map (
...
\test[6]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\test[8]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFBFF00000400"
    )
        port map (
...
\test[8]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\test_reg[8]\: unisim.vcomponents.FDRE
     port map (
      C => axi_aclk,
      CE => '1',
      D => \test[8]_i_1_n_0\,
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter is
  ...
  attribute SOFT_HLUTNM of \brgen_counter[0]_i_1__0\ : label is "soft_lutpair24";
  ...
  attribute SOFT_HLUTNM of out_data_i_4 : label is "soft_lutpair28";
  attribute SOFT_HLUTNM of parity_bit_i_2 : label is "soft_lutpair27";
  attribute SOFT_HLUTNM of \pulse_i_1__1\ : label is "soft_lutpair29";
  attribute SOFT_HLUTNM of rd_request_i_1 : label is "soft_lutpair29";
begin
  ok_to_read_tx <= \^ok_to_read_tx\;
  tx_out <= \^tx_out\;
\FSM_sequential_state[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"FFFFFFFF5050FF51"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  port (
    ...
    \test_reg[8]\ : out STD_LOGIC_VECTOR ( 7 downto 0 );
    watermark : out STD_LOGIC_VECTOR ( 4 downto 0 );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI is
  ...
  signal read_request_detector_tx_n_1 : STD_LOGIC;
...
receiver_1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_receiver
     port map (
      ...
      brgen_counter0 => brgen_counter0,
      brgen_prev => brgen_prev,
      \control_reg[3]\ => receiver_1_n_1,
      ok_to_write_rx => ok_to_write_rx,
      previous_state => previous_state_0,
      \test_reg[8]_0\(7 downto 0) => \test_reg[8]\(7 downto 0),
...
transmitter_1: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_transmitter
     port map (
      D(8 downto 0) => rd_data(8 downto 0),
      E(0) => brgen_counter0,
      \FSM_sequential_state_reg[0]_0\ => receiver_1_n_1,
      Q(4) => data50,
      Q(3) => \control_reg_n_0_[3]\,
      Q(2) => \control_reg_n_0_[2]\,
      Q(1) => \control_reg_n_0_[1]\,
...
serial_v1_0_AXI_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial_v1_0_AXI
     port map (
      ...
      \test_reg[8]\(7 downto 0) => \test_reg[8]\(7 downto 0),
      tx_out => tx_out,
      watermark(4 downto 0) => watermark(4 downto 0),
...
inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_serial
     port map (
      ...
      \test_reg[8]\(7 downto 3) => \^rd_data\(8 downto 4),
      \test_reg[8]\(2 downto 0) => \^rd_data\(2 downto 0),
      tx_out => tx_out,
      watermark(4 downto 0) => watermark(4 downto 0),
      wr_index(4 downto 0) => wr_index(4 downto 0)
    );
