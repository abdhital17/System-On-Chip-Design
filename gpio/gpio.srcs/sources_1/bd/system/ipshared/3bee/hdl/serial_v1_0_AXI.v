        ...
        begin    
            ...
            begin
                ...
                begin
		            ...
		            axi_rdata[8:0] <= rd_data_local_v2[8:0];
...
// buffer rd_data_local to a separate register to prevent race conditon while sending the data on axi_rdata
    reg [8:0] rd_data_local_v2;
    always_ff @ (posedge axi_clk)
    begin
        if (axi_arvalid && axi_arready && ~axi_rvalid)
            rd_data_local_v2 <= rd_data_local;
    end
...
//     .pulse(clear_overflow_request));
  ...
  // Fifo
   ...
   assign rd_data[8:0] = rd_data_local_v2[8:0];
