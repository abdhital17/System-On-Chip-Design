...
`timescale 1 ns / 1 ps
    ...
    wire wr;
    assign wr = wr_add_data_valid && axi_awready && axi_wready;
    ...
    wire rd;
    assign rd = axi_arvalid && axi_arready && ~axi_rvalid;
...
//    .rd_request(read_request_pulse),
   ...
   .empty(empty_local), // debug
   .full(full_local),   // debug
   ...
   assign empty = empty_local;  //debug
   assign full = full_local;    //debug    
